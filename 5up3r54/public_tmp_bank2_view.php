...
$layout->blocks["top"][] = "details";$page_layouts["public_tmp_bank2_view"] = $layout;
...
//judul - 
	...
	if($mainTableOwnerID=="judul")
		$ownerIdValue=$value;
	$xt->assign("judul_value",$value);
...
//lokasi - 
	...
	if($mainTableOwnerID=="lokasi")
		$ownerIdValue=$value;
	$xt->assign("lokasi_value",$value);
...
//j - Number
	...
	if($mainTableOwnerID=="j")
		$ownerIdValue=$value;
	$xt->assign("j_value",$value);
...
//p - Number
	...
	if($mainTableOwnerID=="p")
		$ownerIdValue=$value;
	$xt->assign("p_value",$value);
...
//l - Number
	...
	if($mainTableOwnerID=="l")
		$ownerIdValue=$value;
	$xt->assign("l_value",$value);
...
//t - Number
	...
	if($mainTableOwnerID=="t")
		$ownerIdValue=$value;
	$xt->assign("t_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='public_tmp_bank2_edit.php?".$editlink."'\"");
