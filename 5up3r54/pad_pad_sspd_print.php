...
$layout->blocks["top"][] = "pdf";$page_layouts["pad_pad_sspd_print"] = $layout;
...
$arr = array();
$arr['fName'] = "sisa";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("sisa");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "jenis_bayar";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("jenis_bayar");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "printed";
...
//	sisa - Number
			$record["sisa_value"] = $pageObject->showDBValue("sisa", $data, $keylink);
			$record["sisa_class"] = $pageObject->fieldClass("sisa");
//	jenis_bayar - 
			$record["jenis_bayar_value"] = $pageObject->showDBValue("jenis_bayar", $data, $keylink);
			$record["jenis_bayar_class"] = $pageObject->fieldClass("jenis_bayar");
//	printed - 
...
$xt->assign("sisa_fieldheadercolumn",true);
$xt->assign("sisa_fieldheader",true);
$xt->assign("sisa_fieldcolumn",true);
$xt->assign("sisa_fieldfootercolumn",true);
$xt->assign("jenis_bayar_fieldheadercolumn",true);
$xt->assign("jenis_bayar_fieldheader",true);
$xt->assign("jenis_bayar_fieldcolumn",true);
$xt->assign("jenis_bayar_fieldfootercolumn",true);
