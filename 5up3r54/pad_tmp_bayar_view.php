...
$layout->blocks["top"][] = "details";$page_layouts["pad_tmp_bayar_view"] = $layout;
...
//old_spt_id - 
	...
	if($mainTableOwnerID=="old_spt_id")
		$ownerIdValue=$value;
	$xt->assign("old_spt_id_value",$value);
...
//wp - 
	...
	if($mainTableOwnerID=="wp")
		$ownerIdValue=$value;
	$xt->assign("wp_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pad_tmp_bayar_edit.php?".$editlink."'\"");
