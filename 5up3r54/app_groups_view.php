...
$layout->blocks["top"][] = "details";$page_layouts["app_groups_view"] = $layout;
...
$arr = array();
$arr['fName'] = "locked";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("locked");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "kode";
...
//locked - 
	...
	if($mainTableOwnerID=="locked")
		$ownerIdValue=$value;
	$xt->assign("locked_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='app_groups_edit.php?".$editlink."'\"");
