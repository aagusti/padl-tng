<?php
include_once(getabspath("include/app_groups_settings.php"));

function DisplayMasterTableInfo_app_groups($params)
{
...
if($detailtable == "app.group_modules")
{
...
//	locked - 
			$value="";
					...
					$xt->assign("locked_mastervalue", $viewControls->showDBValue("locked", $data, $keylink));
...
//	kode - 
	...
	$xt->display("app_groups_masterlist.htm");
