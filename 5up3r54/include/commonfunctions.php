...
function checkTableName($shortTName, $type=false)
{
	...
	if ("pad_pad_spt" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_spt_reklame" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_air_tanah_hit" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_air_tanah" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("app_users" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("public_pad_invoice" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_kohir" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_customer_usaha" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_customer" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("app_app_status" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("app_apps" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("app_group_modules" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("app_groups" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("app_modules" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("app_user_groups" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_air_hda" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_air_kelompok_usaha" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_air_manfaat" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_air_zona" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_anggaran" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_customer_detail" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_customer_usaha_air_tanah" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_daftar" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_daftar_hist" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_daftar_kd_det" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_daftar_status" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_jenis_pajak" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_kecamatan" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_kelurahan" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_pegawai" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_pemda" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_periksa" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_rekening" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_reklame" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_reklame_jalan" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_reklame_kelas_jalan" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_reklame_lokasi_pasang" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_reklame_mall" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_reklame_media" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_reklame_nilai_strategis" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_reklame_nsr" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_reklame_sudut_pandang" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_report" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_spt_type" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_sspd" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_stpd" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_tarif_pajak" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_teguran" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_terima" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_terima_line" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_pad_usaha" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_tmp_bayar" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_units" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pad_user_pad" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("public_ar_payment_detail" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("public_pad_channel" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("public_pad_payment" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("public_pad_reversal" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("public_pad_sspd_bak" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("public_tblpejabat2" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("public_pad_tp" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("public_tmp_bank" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("public_tmp_bank_2013" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("public_tmp_bank_ok_1" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("public_tmp_bank2" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("public_tmp_bank2_null_sspd" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	$arr = array();
		$arr[]="pad.pad_spt";
		$arr[]="pad.pad_spt_reklame";
		$arr[]="pad.pad_air_tanah_hit";
		$arr[]="pad.pad_air_tanah";
		$arr[]="app.users";
		$arr[]="public.pad_invoice";
		$arr[]="pad.pad_kohir";
		$arr[]="pad.pad_customer_usaha";
		$arr[]="pad.pad_customer";
		$arr[]="app.app_status";
		$arr[]="app.apps";
		$arr[]="app.group_modules";
		$arr[]="app.groups";
		$arr[]="app.modules";
		$arr[]="app.user_groups";
		$arr[]="pad.pad_air_hda";
		$arr[]="pad.pad_air_kelompok_usaha";
		$arr[]="pad.pad_air_manfaat";
		$arr[]="pad.pad_air_zona";
		$arr[]="pad.pad_anggaran";
		$arr[]="pad.pad_customer_detail";
		$arr[]="pad.pad_customer_usaha_air_tanah";
		$arr[]="pad.pad_daftar";
		$arr[]="pad.pad_daftar_hist";
		$arr[]="pad.pad_daftar_kd_det";
		$arr[]="pad.pad_daftar_status";
		$arr[]="pad.pad_jenis_pajak";
		$arr[]="pad.pad_kecamatan";
		$arr[]="pad.pad_kelurahan";
		$arr[]="pad.pad_pegawai";
		$arr[]="pad.pad_pemda";
		$arr[]="pad.pad_periksa";
		$arr[]="pad.pad_rekening";
		$arr[]="pad.pad_reklame";
		$arr[]="pad.pad_reklame_jalan";
		$arr[]="pad.pad_reklame_kelas_jalan";
		$arr[]="pad.pad_reklame_lokasi_pasang";
		$arr[]="pad.pad_reklame_mall";
		$arr[]="pad.pad_reklame_media";
		$arr[]="pad.pad_reklame_nilai_strategis";
		$arr[]="pad.pad_reklame_nsr";
		$arr[]="pad.pad_reklame_sudut_pandang";
		$arr[]="pad.pad_report";
		$arr[]="pad.pad_spt_type";
		$arr[]="pad.pad_sspd";
		$arr[]="pad.pad_stpd";
		$arr[]="pad.pad_tarif_pajak";
		$arr[]="pad.pad_teguran";
		$arr[]="pad.pad_terima";
		$arr[]="pad.pad_terima_line";
		$arr[]="pad.pad_usaha";
		$arr[]="pad.tmp_bayar";
		$arr[]="pad.units";
		$arr[]="pad.user_pad";
		$arr[]="public.ar_payment_detail";
		$arr[]="public.pad_channel";
		$arr[]="public.pad_payment";
		$arr[]="public.pad_reversal";
		$arr[]="public.pad_sspd_bak";
		$arr[]="public.tblpejabat2";
		$arr[]="public.pad_tp";
		$arr[]="public.tmp_bank";
		$arr[]="public.tmp_bank_2013";
		$arr[]="public.tmp_bank_ok_1";
		$arr[]="public.tmp_bank2";
		$arr[]="public.tmp_bank2_null_sspd";
	return $arr;
}
...
//	default permissions	
	if($table=="pad.pad_spt")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_spt_reklame")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_air_tanah_hit")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_air_tanah")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
...
//	default permissions	
	if($table=="public.pad_invoice")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_kohir")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_customer_usaha")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_customer")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="app.app_status")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
...
//	default permissions	
	if($table=="pad.pad_air_hda")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_air_kelompok_usaha")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_air_manfaat")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_air_zona")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_anggaran")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_customer_detail")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_customer_usaha_air_tanah")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_daftar")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_daftar_hist")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_daftar_kd_det")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_daftar_status")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_jenis_pajak")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_kecamatan")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_kelurahan")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_pegawai")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_pemda")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_periksa")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_rekening")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_reklame")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_reklame_jalan")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_reklame_kelas_jalan")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_reklame_lokasi_pasang")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_reklame_mall")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_reklame_media")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_reklame_nilai_strategis")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_reklame_nsr")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_reklame_sudut_pandang")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_report")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_spt_type")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_sspd")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_stpd")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_tarif_pajak")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_teguran")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_terima")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_terima_line")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.pad_usaha")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="pad.tmp_bayar")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
...
//	default permissions	
	if($table=="pad.user_pad")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="public.ar_payment_detail")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="public.pad_channel")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="public.pad_payment")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="public.pad_reversal")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="public.pad_sspd_bak")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="public.tblpejabat2")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="public.pad_tp")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="public.tmp_bank")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="public.tmp_bank_2013")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="public.tmp_bank_ok_1")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="public.tmp_bank2")
	{
	return "ADESPI";// grant all by default
	}
//	default permissions	
	if($table=="public.tmp_bank2_null_sspd")
	{
	return "ADESPI";// grant all by default
	}
}
