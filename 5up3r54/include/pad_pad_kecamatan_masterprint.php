...
//$strSQL = "SELECT id,   kode,   nama,   tmt,   enabled,   created,   create_uid,   updated,   update_uid,   zona_id  FROM \"pad\".pad_kecamatan ";
...
//	zona_id - 
	...
	$xt->display("pad_pad_kecamatan_masterprint.htm");
	$strTableName=$oldTableName;
