<?php
include_once(getabspath("include/pad_pad_air_manfaat_settings.php"));

function DisplayMasterTableInfo_pad_pad_air_manfaat($params)
{
...
//$strSQL = "SELECT id,   nama,   update_uid,   create_uid,   updated,   created  FROM \"pad\".pad_air_manfaat ";
...
$layout->blocks["bare"][] = "mastergrid";$page_layouts["pad_pad_air_manfaat_masterprint"] = $layout;
...
//	created - Short Date
	...
	$xt->display("pad_pad_air_manfaat_masterprint.htm");
	$strTableName=$oldTableName;
