...
$layout->blocks["top"][] = "details";$page_layouts["pad_pad_reklame_jalan_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pad_pad_reklame_jalan_edit.php?".$editlink."'\"");
