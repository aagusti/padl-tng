...
$layout->blocks["top"][] = "details";$page_layouts["pad_pad_reklame_view"] = $layout;
...
//pemilik_nama - 
	...
	if($mainTableOwnerID=="pemilik_nama")
		$ownerIdValue=$value;
	$xt->assign("pemilik_nama_value",$value);
...
//pemilik_alamat - 
	...
	if($mainTableOwnerID=="pemilik_alamat")
		$ownerIdValue=$value;
	$xt->assign("pemilik_alamat_value",$value);
...
//pemilik_kecamatan - 
	...
	if($mainTableOwnerID=="pemilik_kecamatan")
		$ownerIdValue=$value;
	$xt->assign("pemilik_kecamatan_value",$value);
...
//pemilik_kelurahan - 
	...
	if($mainTableOwnerID=="pemilik_kelurahan")
		$ownerIdValue=$value;
	$xt->assign("pemilik_kelurahan_value",$value);
...
//pemilik_kota - 
	...
	if($mainTableOwnerID=="pemilik_kota")
		$ownerIdValue=$value;
	$xt->assign("pemilik_kota_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pad_pad_reklame_edit.php?".$editlink."'\"");
