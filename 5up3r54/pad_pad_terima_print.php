...
$layout->blocks["top"][] = "pdf";$page_layouts["pad_pad_terima_print"] = $layout;
...
$arr = array();
$arr['fName'] = "terimano";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("terimano");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "terimatgl";
...
$arr = array();
$arr['fName'] = "jmlterima";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("jmlterima");
$fieldsArr[] = $arr;
$arr = array();
...
$arr = array();
$arr['fName'] = "nobukti";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("nobukti");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "notes";
...
//	terimano - 
			$record["terimano_value"] = $pageObject->showDBValue("terimano", $data, $keylink);
			$record["terimano_class"] = $pageObject->fieldClass("terimano");
//	terimatgl - Short Date
			$record["terimatgl_value"] = $pageObject->showDBValue("terimatgl", $data, $keylink);
			$record["terimatgl_class"] = $pageObject->fieldClass("terimatgl");
//	jmlterima - Number
			$record["jmlterima_value"] = $pageObject->showDBValue("jmlterima", $data, $keylink);
			$record["jmlterima_class"] = $pageObject->fieldClass("jmlterima");
//	customer_id - 
...
//	nobukti - 
			$record["nobukti_value"] = $pageObject->showDBValue("nobukti", $data, $keylink);
			$record["nobukti_class"] = $pageObject->fieldClass("nobukti");
//	notes - 
...
//	include proper masterprint.php code
	...
	$params = array("detailtable"=>"pad.pad_terima","keys"=>$masterkeys);
	$master = array();
...
$xt->assign("terimano_fieldheadercolumn",true);
$xt->assign("terimano_fieldheader",true);
$xt->assign("terimano_fieldcolumn",true);
$xt->assign("terimano_fieldfootercolumn",true);
$xt->assign("terimatgl_fieldheadercolumn",true);
$xt->assign("terimatgl_fieldheader",true);
$xt->assign("terimatgl_fieldcolumn",true);
$xt->assign("terimatgl_fieldfootercolumn",true);
$xt->assign("jmlterima_fieldheadercolumn",true);
$xt->assign("jmlterima_fieldheader",true);
$xt->assign("jmlterima_fieldcolumn",true);
$xt->assign("jmlterima_fieldfootercolumn",true);
...
$xt->assign("nobukti_fieldheadercolumn",true);
$xt->assign("nobukti_fieldheader",true);
$xt->assign("nobukti_fieldcolumn",true);
$xt->assign("nobukti_fieldfootercolumn",true);
