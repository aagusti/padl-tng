...
$layout->blocks["top"][] = "search";$page_layouts["pad_pad_reklame_search"] = $layout;
...
$mode = SEARCH_SIMPLE;
$templatefile = "pad_pad_reklame_search.htm";
...
$params['shortTableName'] = 'pad_pad_reklame';
...
if ($mode==SEARCH_SIMPLE)
{
	...
	if($pageObject->pSet->getLookupTable("pemilik_nama"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("pemilik_nama")] = GetTableURL($pageObject->pSet->getLookupTable("pemilik_nama"));
	
	$pageObject->fillFieldToolTips("pemilik_nama");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("pemilik_nama");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "pemilik_nama";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("pemilik_nama_label","<label for=\"".GetInputElementId("pemilik_nama", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("pemilik_nama_label", true);
	
	$xt->assign("pemilik_nama_fieldblock", true);
	$xt->assignbyref("pemilik_nama_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("pemilik_nama_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("pemilik_nama_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_pemilik_nama", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("pemilik_nama");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"pemilik_nama", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"pemilik_nama", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
	
	if($pageObject->pSet->getLookupTable("pemilik_alamat"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("pemilik_alamat")] = GetTableURL($pageObject->pSet->getLookupTable("pemilik_alamat"));
	
	$pageObject->fillFieldToolTips("pemilik_alamat");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("pemilik_alamat");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "pemilik_alamat";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("pemilik_alamat_label","<label for=\"".GetInputElementId("pemilik_alamat", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("pemilik_alamat_label", true);
	
	$xt->assign("pemilik_alamat_fieldblock", true);
	$xt->assignbyref("pemilik_alamat_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("pemilik_alamat_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("pemilik_alamat_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_pemilik_alamat", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("pemilik_alamat");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"pemilik_alamat", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"pemilik_alamat", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
	
	if($pageObject->pSet->getLookupTable("pemilik_kecamatan"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("pemilik_kecamatan")] = GetTableURL($pageObject->pSet->getLookupTable("pemilik_kecamatan"));
	
	$pageObject->fillFieldToolTips("pemilik_kecamatan");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("pemilik_kecamatan");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "pemilik_kecamatan";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("pemilik_kecamatan_label","<label for=\"".GetInputElementId("pemilik_kecamatan", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("pemilik_kecamatan_label", true);
	
	$xt->assign("pemilik_kecamatan_fieldblock", true);
	$xt->assignbyref("pemilik_kecamatan_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("pemilik_kecamatan_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("pemilik_kecamatan_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_pemilik_kecamatan", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("pemilik_kecamatan");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"pemilik_kecamatan", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"pemilik_kecamatan", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
	
	if($pageObject->pSet->getLookupTable("pemilik_kelurahan"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("pemilik_kelurahan")] = GetTableURL($pageObject->pSet->getLookupTable("pemilik_kelurahan"));
	
	$pageObject->fillFieldToolTips("pemilik_kelurahan");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("pemilik_kelurahan");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "pemilik_kelurahan";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("pemilik_kelurahan_label","<label for=\"".GetInputElementId("pemilik_kelurahan", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("pemilik_kelurahan_label", true);
	
	$xt->assign("pemilik_kelurahan_fieldblock", true);
	$xt->assignbyref("pemilik_kelurahan_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("pemilik_kelurahan_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("pemilik_kelurahan_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_pemilik_kelurahan", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("pemilik_kelurahan");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"pemilik_kelurahan", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"pemilik_kelurahan", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
	
	if($pageObject->pSet->getLookupTable("pemilik_kota"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("pemilik_kota")] = GetTableURL($pageObject->pSet->getLookupTable("pemilik_kota"));
	
	$pageObject->fillFieldToolTips("pemilik_kota");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("pemilik_kota");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "pemilik_kota";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("pemilik_kota_label","<label for=\"".GetInputElementId("pemilik_kota", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("pemilik_kota_label", true);
	
	$xt->assign("pemilik_kota_fieldblock", true);
	$xt->assignbyref("pemilik_kota_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("pemilik_kota_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("pemilik_kota_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_pemilik_kota", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("pemilik_kota");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"pemilik_kota", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"pemilik_kota", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
