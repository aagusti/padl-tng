...
$layout->blocks["top"][] = "details";$page_layouts["pad_pad_reklame_media_view"] = $layout;
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "jenis_pajak_id";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("jenis_pajak_id");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "media";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("media");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "singkatan";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("singkatan");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "masa";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("masa");
$fieldsArr[] = $arr;
$arr = array();
...
//jenis_pajak_id - 
	...
	if($mainTableOwnerID=="jenis_pajak_id")
		$ownerIdValue=$value;
	$xt->assign("jenis_pajak_id_value",$value);
...
//media - 
	...
	if($mainTableOwnerID=="media")
		$ownerIdValue=$value;
	$xt->assign("media_value",$value);
...
//singkatan - 
	...
	if($mainTableOwnerID=="singkatan")
		$ownerIdValue=$value;
	$xt->assign("singkatan_value",$value);
...
//masa - 
	...
	if($mainTableOwnerID=="masa")
		$ownerIdValue=$value;
	$xt->assign("masa_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pad_pad_reklame_media_edit.php?".$editlink."'\"");
