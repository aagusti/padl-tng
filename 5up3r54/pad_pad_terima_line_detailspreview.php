...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["pad_pad_terima_line_detailspreview"] = $layout;
...
if($rowcount) {
	...
	//	terima_id - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("terima_id", $data, $keylink);
			$row["terima_id_value"] = $value;
	//	spt_id - 
			$viewContainer->recId = $recordsCounter;
...
$xt->load_template("pad_pad_terima_line_detailspreview.htm");
