...
$layout->blocks["top"][] = "pdf";$page_layouts["pad_pad_tarif_pajak_print"] = $layout;
...
$arr = array();
$arr['fName'] = "reklame";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("reklame");
$fieldsArr[] = $arr;
$arr = array();
...
//	reklame - Number
			$record["reklame_value"] = $pageObject->showDBValue("reklame", $data, $keylink);
			$record["reklame_class"] = $pageObject->fieldClass("reklame");
//	minimal_omset - Number
			$record["minimal_omset_value"] = $pageObject->showDBValue("minimal_omset", $data, $keylink);
			$record["minimal_omset_class"] = $pageObject->fieldClass("minimal_omset");
//	tmt - Short Date
...
//	include proper masterprint.php code
	...
	$params = array("detailtable"=>"pad.pad_tarif_pajak","keys"=>$masterkeys);
	$master = array();
...
$xt->assign("reklame_fieldheadercolumn",true);
$xt->assign("reklame_fieldheader",true);
$xt->assign("reklame_fieldcolumn",true);
$xt->assign("reklame_fieldfootercolumn",true);
$xt->assign("minimal_omset_fieldheadercolumn",true);
$xt->assign("minimal_omset_fieldheader",true);
$xt->assign("minimal_omset_fieldcolumn",true);
$xt->assign("minimal_omset_fieldfootercolumn",true);
