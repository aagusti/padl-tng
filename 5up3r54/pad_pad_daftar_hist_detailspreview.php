...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["pad_pad_daftar_hist_detailspreview"] = $layout;
...
{
	$where = "";
		$where .= GetFullFieldName("status_id", $strTableName, false)."=".make_db_value("status_id",$_SESSION[$strTableName."_masterkey1"]);
}
