...
$layout->blocks["top"][] = "details";$page_layouts["pad_pad_daftar_kd_det_view"] = $layout;
...
//daftar_id - 
	...
	if($mainTableOwnerID=="daftar_id")
		$ownerIdValue=$value;
	$xt->assign("daftar_id_value",$value);
...
//nourut - 
	...
	if($mainTableOwnerID=="nourut")
		$ownerIdValue=$value;
	$xt->assign("nourut_value",$value);
...
//kamar - 
	...
	if($mainTableOwnerID=="kamar")
		$ownerIdValue=$value;
	$xt->assign("kamar_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pad_pad_daftar_kd_det_edit.php?".$editlink."'\"");
