...
$layout->blocks["top"][] = "pdf";$page_layouts["pad_pad_pegawai_print"] = $layout;
...
//	pangkat - 
			$record["pangkat_value"] = $pageObject->showDBValue("pangkat", $data, $keylink);
			$record["pangkat_class"] = $pageObject->fieldClass("pangkat");
//	tmt - Short Date
...
//	nomor_telp - 
			$record["nomor_telp_value"] = $pageObject->showDBValue("nomor_telp", $data, $keylink);
			$record["nomor_telp_class"] = $pageObject->fieldClass("nomor_telp");
//	bagian - 
			$record["bagian_value"] = $pageObject->showDBValue("bagian", $data, $keylink);
			$record["bagian_class"] = $pageObject->fieldClass("bagian");
//	created - Short Date
...
$xt->assign("pangkat_fieldheadercolumn",true);
$xt->assign("pangkat_fieldheader",true);
$xt->assign("pangkat_fieldcolumn",true);
$xt->assign("pangkat_fieldfootercolumn",true);
...
$xt->assign("nomor_telp_fieldheadercolumn",true);
$xt->assign("nomor_telp_fieldheader",true);
$xt->assign("nomor_telp_fieldcolumn",true);
$xt->assign("nomor_telp_fieldfootercolumn",true);
$xt->assign("bagian_fieldheadercolumn",true);
$xt->assign("bagian_fieldheader",true);
$xt->assign("bagian_fieldcolumn",true);
$xt->assign("bagian_fieldfootercolumn",true);
