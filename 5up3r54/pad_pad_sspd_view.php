...
$layout->blocks["top"][] = "details";$page_layouts["pad_pad_sspd_view"] = $layout;
...
//sspdno - 
	...
	if($mainTableOwnerID=="sspdno")
		$ownerIdValue=$value;
	$xt->assign("sspdno_value",$value);
...
//sspdtgl - Short Date
	...
	if($mainTableOwnerID=="sspdtgl")
		$ownerIdValue=$value;
	$xt->assign("sspdtgl_value",$value);
...
//sspdjam - Time
	...
	if($mainTableOwnerID=="sspdjam")
		$ownerIdValue=$value;
	$xt->assign("sspdjam_value",$value);
...
//hitung_bunga - 
	...
	if($mainTableOwnerID=="hitung_bunga")
		$ownerIdValue=$value;
	$xt->assign("hitung_bunga_value",$value);
...
//jml_bayar - 
	...
	if($mainTableOwnerID=="jml_bayar")
		$ownerIdValue=$value;
	$xt->assign("jml_bayar_value",$value);
...
//sisa - Number
	...
	if($mainTableOwnerID=="sisa")
		$ownerIdValue=$value;
	$xt->assign("sisa_value",$value);
...
//jenis_bayar - 
	...
	if($mainTableOwnerID=="jenis_bayar")
		$ownerIdValue=$value;
	$xt->assign("jenis_bayar_value",$value);
...
//tp_id - 
	...
	if($mainTableOwnerID=="tp_id")
		$ownerIdValue=$value;
	$xt->assign("tp_id_value",$value);
...
//is_validated - 
	...
	if($mainTableOwnerID=="is_validated")
		$ownerIdValue=$value;
	$xt->assign("is_validated_value",$value);
...
//is_valid - 
	...
	if($mainTableOwnerID=="is_valid")
		$ownerIdValue=$value;
	$xt->assign("is_valid_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pad_pad_sspd_edit.php?".$editlink."'\"");
