...
$layout->blocks["top"][] = "search";$page_layouts["app_group_modules_list"] = $layout;
...
{	
	...
	//determine which field should be used to select values
			$params["lookupSelectField"] = "group_id";
						}
...
$layout->blocks["bare"][] = "mastergrid";$page_layouts["app_groups_masterlist"] = $layout;

$layout = GetPageLayout("app_groups", 'masterlist');
if($layout)
{
...
$viewControls = new ViewControlsContainer(new ProjectSettings("app.groups", PAGE_LIST), PAGE_LIST);
...
$layout->skins["mastergrid"] = "grid";
$layout->blocks["bare"][] = "mastergrid";$page_layouts["app_modules_masterlist"] = $layout;
