...
$layout->blocks["top"][] = "pdf";$page_layouts["pad_tmp_bayar_print"] = $layout;
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "old_spt_id";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("old_spt_id");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "wp";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("wp");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "bunga";
...
//	old_spt_id - 
			$record["old_spt_id_value"] = $pageObject->showDBValue("old_spt_id", $data, $keylink);
			$record["old_spt_id_class"] = $pageObject->fieldClass("old_spt_id");
//	wp - 
			$record["wp_value"] = $pageObject->showDBValue("wp", $data, $keylink);
			$record["wp_class"] = $pageObject->fieldClass("wp");
//	bunga - 
...
$xt->assign("old_spt_id_fieldheadercolumn",true);
$xt->assign("old_spt_id_fieldheader",true);
$xt->assign("old_spt_id_fieldcolumn",true);
$xt->assign("old_spt_id_fieldfootercolumn",true);
$xt->assign("wp_fieldheadercolumn",true);
$xt->assign("wp_fieldheader",true);
$xt->assign("wp_fieldcolumn",true);
$xt->assign("wp_fieldfootercolumn",true);
