...
$layout->blocks["top"][] = "pdf";$page_layouts["pad_pad_teguran_print"] = $layout;
...
//	teguran_no - 
			$record["teguran_no_value"] = $pageObject->showDBValue("teguran_no", $data, $keylink);
			$record["teguran_no_class"] = $pageObject->fieldClass("teguran_no");
//	invoice_id - 
...
//	cetak_ke - 
			$record["cetak_ke_value"] = $pageObject->showDBValue("cetak_ke", $data, $keylink);
			$record["cetak_ke_class"] = $pageObject->fieldClass("cetak_ke");
//	created - Short Date
...
$xt->assign("teguran_no_fieldheadercolumn",true);
$xt->assign("teguran_no_fieldheader",true);
$xt->assign("teguran_no_fieldcolumn",true);
$xt->assign("teguran_no_fieldfootercolumn",true);
...
$xt->assign("cetak_ke_fieldheadercolumn",true);
$xt->assign("cetak_ke_fieldheader",true);
$xt->assign("cetak_ke_fieldcolumn",true);
$xt->assign("cetak_ke_fieldfootercolumn",true);
