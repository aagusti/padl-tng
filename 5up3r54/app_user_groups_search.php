...
$layout->blocks["top"][] = "search";$page_layouts["app_user_groups_search"] = $layout;
...
$mode = SEARCH_SIMPLE;
$templatefile = "app_user_groups_search.htm";
...
$params['shortTableName'] = 'app_user_groups';
...
if ($mode==SEARCH_SIMPLE)
{
	...
	if($pageObject->pSet->getLookupTable("user_id"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("user_id")] = GetTableURL($pageObject->pSet->getLookupTable("user_id"));
	...
	if(isEnableSection508())
		$xt->assign_section("user_id_label","<label for=\"".GetInputElementId("user_id", $id, PAGE_SEARCH)."\">","</label>");
	else 
