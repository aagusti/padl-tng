...
$strOriginalTableName="\"pad\".\"pad_customer_usaha_air_tanah\"";
if(!isLogged())
{ 
...
$layout->blocks["top"][] = "import";$page_layouts["pad_pad_customer_usaha_air_tanah_import"] = $layout;
...
$xt->display("pad_pad_customer_usaha_air_tanah_import.htm");
