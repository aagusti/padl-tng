...
$layout->blocks["top"][] = "export";$page_layouts["public_tmp_bank2_null_sspd_export"] = $layout;
...
$xt->display("public_tmp_bank2_null_sspd_export.htm");

function ExportToExcel_old($cipherer)
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=public_tmp_bank2_null_sspd.xls");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=public_tmp_bank2_null_sspd.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=public_tmp_bank2_null_sspd.xml");
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=public_tmp_bank2_null_sspd.csv");
