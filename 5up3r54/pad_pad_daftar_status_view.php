...
$layout->blocks["top"][] = "details";$page_layouts["pad_pad_daftar_status_view"] = $layout;
...
$arr = array();
$arr['fName'] = "uraian";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("uraian");
$fieldsArr[] = $arr;
...
//uraian - 
	...
	if($mainTableOwnerID=="uraian")
		$ownerIdValue=$value;
	$xt->assign("uraian_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pad_pad_daftar_status_edit.php?".$editlink."'\"");
