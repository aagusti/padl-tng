...
$layout->blocks["top"][] = "pdf";$page_layouts["pad_pad_stpd_print"] = $layout;
...
$arr = array();
$arr['fName'] = "stpdno";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("stpdno");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "stpdtgl";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("stpdtgl");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "spt_id";
...
$arr = array();
$arr['fName'] = "stpdcount";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("stpdcount");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "bunga";
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "petugas_id";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("petugas_id");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "pejabat_id";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("pejabat_id");
$fieldsArr[] = $arr;
...
//	stpdno - 
			$record["stpdno_value"] = $pageObject->showDBValue("stpdno", $data, $keylink);
			$record["stpdno_class"] = $pageObject->fieldClass("stpdno");
//	stpdtgl - Short Date
			$record["stpdtgl_value"] = $pageObject->showDBValue("stpdtgl", $data, $keylink);
			$record["stpdtgl_class"] = $pageObject->fieldClass("stpdtgl");
//	spt_id - 
...
//	jatuhtempotgl - Short Date
			$record["jatuhtempotgl_value"] = $pageObject->showDBValue("jatuhtempotgl", $data, $keylink);
			$record["jatuhtempotgl_class"] = $pageObject->fieldClass("jatuhtempotgl");
//	printed - 
			$record["printed_value"] = $pageObject->showDBValue("printed", $data, $keylink);
			$record["printed_class"] = $pageObject->fieldClass("printed");
//	stpdcount - 
			$record["stpdcount_value"] = $pageObject->showDBValue("stpdcount", $data, $keylink);
			$record["stpdcount_class"] = $pageObject->fieldClass("stpdcount");
//	bunga - Number
...
//	petugas_id - 
			$record["petugas_id_value"] = $pageObject->showDBValue("petugas_id", $data, $keylink);
			$record["petugas_id_class"] = $pageObject->fieldClass("petugas_id");
//	pejabat_id - 
			$record["pejabat_id_value"] = $pageObject->showDBValue("pejabat_id", $data, $keylink);
			$record["pejabat_id_class"] = $pageObject->fieldClass("pejabat_id");
			if($col<$colsonpage)
...
//	include proper masterprint.php code
	include("include/pad_pad_spt_masterprint.php");
	$masterkeys[] = @$_SESSION[$strTableName."_masterkey1"];
	$params = array("detailtable"=>"pad.pad_stpd","keys"=>$masterkeys);
	$master = array();
	$master["func"] = "DisplayMasterTableInfo_pad_pad_spt";
...
$layout->blocks["bare"][] = "mastergrid";$page_layouts["pad_pad_spt_masterprint"] = $layout;
	...
	$layout = GetPageLayout("pad_pad_spt", 'masterprint');
	if($layout)
	{
...
$xt->assign("stpdno_fieldheadercolumn",true);
$xt->assign("stpdno_fieldheader",true);
$xt->assign("stpdno_fieldcolumn",true);
$xt->assign("stpdno_fieldfootercolumn",true);
$xt->assign("stpdtgl_fieldheadercolumn",true);
$xt->assign("stpdtgl_fieldheader",true);
$xt->assign("stpdtgl_fieldcolumn",true);
$xt->assign("stpdtgl_fieldfootercolumn",true);
...
$xt->assign("jatuhtempotgl_fieldheadercolumn",true);
$xt->assign("jatuhtempotgl_fieldheader",true);
$xt->assign("jatuhtempotgl_fieldcolumn",true);
$xt->assign("jatuhtempotgl_fieldfootercolumn",true);
...
$xt->assign("stpdcount_fieldheadercolumn",true);
$xt->assign("stpdcount_fieldheader",true);
$xt->assign("stpdcount_fieldcolumn",true);
$xt->assign("stpdcount_fieldfootercolumn",true);
...
$xt->assign("petugas_id_fieldheadercolumn",true);
$xt->assign("petugas_id_fieldheader",true);
$xt->assign("petugas_id_fieldcolumn",true);
$xt->assign("petugas_id_fieldfootercolumn",true);
$xt->assign("pejabat_id_fieldheadercolumn",true);
$xt->assign("pejabat_id_fieldheader",true);
$xt->assign("pejabat_id_fieldcolumn",true);
$xt->assign("pejabat_id_fieldfootercolumn",true);
