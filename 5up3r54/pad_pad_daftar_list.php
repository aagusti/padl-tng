...
include_once("include/pad_pad_daftar_hist_settings.php");
include_once("include/pad_pad_daftar_kd_det_settings.php");
...
$layout->blocks["top"][] = "search";$page_layouts["pad_pad_daftar_list"] = $layout;
