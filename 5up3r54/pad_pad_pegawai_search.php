...
include("include/pad_pad_pegawai_variables.php");
...
$layout->blocks["top"][] = "search";$page_layouts["pad_pad_pegawai_search"] = $layout;
...
$mode = SEARCH_SIMPLE;
$templatefile = "pad_pad_pegawai_search.htm";
...
$params['shortTableName'] = 'pad_pad_pegawai';
...
if ($mode==SEARCH_SIMPLE)
{
	...
	if($pageObject->pSet->getLookupTable("pangkat"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("pangkat")] = GetTableURL($pageObject->pSet->getLookupTable("pangkat"));
	
	$pageObject->fillFieldToolTips("pangkat");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("pangkat");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "pangkat";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("pangkat_label","<label for=\"".GetInputElementId("pangkat", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("pangkat_label", true);
	
	$xt->assign("pangkat_fieldblock", true);
	$xt->assignbyref("pangkat_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("pangkat_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("pangkat_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_pangkat", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("pangkat");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"pangkat", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"pangkat", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
	...
	if($pageObject->pSet->getLookupTable("nomor_telp"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("nomor_telp")] = GetTableURL($pageObject->pSet->getLookupTable("nomor_telp"));
	
	$pageObject->fillFieldToolTips("nomor_telp");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("nomor_telp");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "nomor_telp";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("nomor_telp_label","<label for=\"".GetInputElementId("nomor_telp", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("nomor_telp_label", true);
	
	$xt->assign("nomor_telp_fieldblock", true);
	$xt->assignbyref("nomor_telp_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("nomor_telp_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("nomor_telp_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_nomor_telp", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("nomor_telp");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"nomor_telp", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"nomor_telp", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
	
	if($pageObject->pSet->getLookupTable("bagian"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("bagian")] = GetTableURL($pageObject->pSet->getLookupTable("bagian"));
	
	$pageObject->fillFieldToolTips("bagian");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("bagian");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	if(isEnableSection508())
		$xt->assign_section("bagian_label","<label for=\"".GetInputElementId("bagian", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("bagian_label", true);
	
	$xt->assign("bagian_fieldblock", true);
	$xt->assignbyref("bagian_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("bagian_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("bagian_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_bagian", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("bagian");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"bagian", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"bagian", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
