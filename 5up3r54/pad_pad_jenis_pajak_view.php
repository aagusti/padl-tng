...
$layout->blocks["top"][] = "details";$page_layouts["pad_pad_jenis_pajak_view"] = $layout;
...
//rekening_kd_sub - 
	...
	if($mainTableOwnerID=="rekening_kd_sub")
		$ownerIdValue=$value;
	$xt->assign("rekening_kd_sub_value",$value);
...
//rekdenda_id - 
	...
	if($mainTableOwnerID=="rekdenda_id")
		$ownerIdValue=$value;
	$xt->assign("rekdenda_id_value",$value);
...
//masapajak - 
	...
	if($mainTableOwnerID=="masapajak")
		$ownerIdValue=$value;
	$xt->assign("masapajak_value",$value);
...
//jatuhtempo - 
	...
	if($mainTableOwnerID=="jatuhtempo")
		$ownerIdValue=$value;
	$xt->assign("jatuhtempo_value",$value);
...
//jalan_kelas_id - 
	...
	if($mainTableOwnerID=="jalan_kelas_id")
		$ownerIdValue=$value;
	$xt->assign("jalan_kelas_id_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pad_pad_jenis_pajak_edit.php?".$editlink."'\"");
