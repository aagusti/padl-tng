...
$strOriginalTableName="\"pad\".\"pad_reklame_lokasi_pasang\"";
if(!isLogged())
{ 
...
$layout = new TLayout("import","RoundedGreen","MobileGreen");
...
$layout->blocks["top"][] = "import";$page_layouts["pad_pad_reklame_lokasi_pasang_import"] = $layout;
...
$xt->display("pad_pad_reklame_lokasi_pasang_import.htm");
