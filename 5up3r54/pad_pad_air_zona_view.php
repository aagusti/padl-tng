...
$layout->blocks["top"][] = "details";$page_layouts["pad_pad_air_zona_view"] = $layout;
...
$arr = array();
$arr['fName'] = "indeks";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("indeks");
$fieldsArr[] = $arr;
$arr = array();
...
//indeks - Number
	...
	if($mainTableOwnerID=="indeks")
		$ownerIdValue=$value;
	$xt->assign("indeks_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pad_pad_air_zona_edit.php?".$editlink."'\"");
