...
$layout->blocks["top"][] = "details";$page_layouts["pad_pad_stpd_view"] = $layout;
...
//stpdno - 
	...
	if($mainTableOwnerID=="stpdno")
		$ownerIdValue=$value;
	$xt->assign("stpdno_value",$value);
...
//stpdtgl - Short Date
	...
	if($mainTableOwnerID=="stpdtgl")
		$ownerIdValue=$value;
	$xt->assign("stpdtgl_value",$value);
...
//printed - 
	...
	if($mainTableOwnerID=="printed")
		$ownerIdValue=$value;
	$xt->assign("printed_value",$value);
...
//stpdcount - 
	...
	if($mainTableOwnerID=="stpdcount")
		$ownerIdValue=$value;
	$xt->assign("stpdcount_value",$value);
...
//petugas_id - 
	...
	if($mainTableOwnerID=="petugas_id")
		$ownerIdValue=$value;
	$xt->assign("petugas_id_value",$value);
...
//pejabat_id - 
	...
	if($mainTableOwnerID=="pejabat_id")
		$ownerIdValue=$value;
	$xt->assign("pejabat_id_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pad_pad_stpd_edit.php?".$editlink."'\"");
