...
$layout->blocks["top"][] = "pdf";$page_layouts["pad_pad_spt_type_print"] = $layout;
...
//	typenm - 
			$record["typenm_value"] = $pageObject->showDBValue("typenm", $data, $keylink);
			$record["typenm_class"] = $pageObject->fieldClass("typenm");
//	tmt - Short Date
...
$xt->assign("typenm_fieldheadercolumn",true);
$xt->assign("typenm_fieldheader",true);
$xt->assign("typenm_fieldcolumn",true);
$xt->assign("typenm_fieldfootercolumn",true);
