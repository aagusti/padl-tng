...
$layout->blocks["top"][] = "export";$page_layouts["pad_pad_reklame_lokasi_pasang_export"] = $layout;
...
$xt->display("pad_pad_reklame_lokasi_pasang_export.htm");

function ExportToExcel_old($cipherer)
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=pad_pad_reklame_lokasi_pasang.xls");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=pad_pad_reklame_lokasi_pasang.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=pad_pad_reklame_lokasi_pasang.xml");
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=pad_pad_reklame_lokasi_pasang.csv");
