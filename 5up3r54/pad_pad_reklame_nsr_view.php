...
$layout->blocks["top"][] = "details";$page_layouts["pad_pad_reklame_nsr_view"] = $layout;
...
//njopr - Number
	...
	if($mainTableOwnerID=="njopr")
		$ownerIdValue=$value;
	$xt->assign("njopr_value",$value);
...
//nspr - Number
	...
	if($mainTableOwnerID=="nspr")
		$ownerIdValue=$value;
	$xt->assign("nspr_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pad_pad_reklame_nsr_edit.php?".$editlink."'\"");
