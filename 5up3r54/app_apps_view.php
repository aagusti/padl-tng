...
$layout->blocks["top"][] = "details";$page_layouts["app_apps_view"] = $layout;
...
$arr = array();
$arr['fName'] = "app_path";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("app_path");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "disabled";
...
//app_path - 
	...
	if($mainTableOwnerID=="app_path")
		$ownerIdValue=$value;
	$xt->assign("app_path_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='app_apps_edit.php?".$editlink."'\"");
