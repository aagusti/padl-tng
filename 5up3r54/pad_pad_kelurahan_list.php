...
include_once("include/pad_pad_customer_settings.php");
include_once("include/pad_pad_daftar_settings.php");
...
$layout->blocks["top"][] = "search";$page_layouts["pad_pad_kelurahan_list"] = $layout;
