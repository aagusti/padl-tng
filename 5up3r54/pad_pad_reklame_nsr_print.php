...
$layout->blocks["top"][] = "pdf";$page_layouts["pad_pad_reklame_nsr_print"] = $layout;
...
$arr = array();
$arr['fName'] = "njopr";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("njopr");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "nspr";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("nspr");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "nsr";
...
//	njopr - Number
			$record["njopr_value"] = $pageObject->showDBValue("njopr", $data, $keylink);
			$record["njopr_class"] = $pageObject->fieldClass("njopr");
//	nspr - Number
			$record["nspr_value"] = $pageObject->showDBValue("nspr", $data, $keylink);
			$record["nspr_class"] = $pageObject->fieldClass("nspr");
//	nsr - Number
...
$xt->assign("njopr_fieldheadercolumn",true);
$xt->assign("njopr_fieldheader",true);
$xt->assign("njopr_fieldcolumn",true);
$xt->assign("njopr_fieldfootercolumn",true);
$xt->assign("nspr_fieldheadercolumn",true);
$xt->assign("nspr_fieldheader",true);
$xt->assign("nspr_fieldcolumn",true);
$xt->assign("nspr_fieldfootercolumn",true);
