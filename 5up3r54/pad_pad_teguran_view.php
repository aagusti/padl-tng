...
$layout->blocks["top"][] = "details";$page_layouts["pad_pad_teguran_view"] = $layout;
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "teguran_no";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("teguran_no");
$fieldsArr[] = $arr;
$arr = array();
...
$arr = array();
$arr['fName'] = "cetak_ke";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("cetak_ke");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "created";
...
//teguran_no - 
	...
	if($mainTableOwnerID=="teguran_no")
		$ownerIdValue=$value;
	$xt->assign("teguran_no_value",$value);
...
//cetak_ke - 
	...
	if($mainTableOwnerID=="cetak_ke")
		$ownerIdValue=$value;
	$xt->assign("cetak_ke_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pad_pad_teguran_edit.php?".$editlink."'\"");
