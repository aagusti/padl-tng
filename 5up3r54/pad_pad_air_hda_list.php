...
$layout->blocks["top"][] = "search";$page_layouts["pad_pad_air_hda_list"] = $layout;
...
$layout->blocks["bare"][] = "mastergrid";$page_layouts["pad_pad_air_manfaat_masterlist"] = $layout;

$layout = GetPageLayout("pad_pad_air_manfaat", 'masterlist');
if($layout)
{
...
$viewControls = new ViewControlsContainer(new ProjectSettings("pad.pad_air_manfaat", PAGE_LIST), PAGE_LIST);
...
$layout->skins["mastergrid"] = "grid";
$layout->blocks["bare"][] = "mastergrid";$page_layouts["pad_pad_air_zona_masterlist"] = $layout;
