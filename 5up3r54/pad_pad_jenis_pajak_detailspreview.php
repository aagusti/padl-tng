...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["pad_pad_jenis_pajak_detailspreview"] = $layout;
...
if($rowcount) {
	...
	//	rekening_kd_sub - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("rekening_kd_sub", $data, $keylink);
			$row["rekening_kd_sub_value"] = $value;
	//	rekdenda_id - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("rekdenda_id", $data, $keylink);
			$row["rekdenda_id_value"] = $value;
	//	masapajak - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("masapajak", $data, $keylink);
			$row["masapajak_value"] = $value;
	//	jatuhtempo - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("jatuhtempo", $data, $keylink);
			$row["jatuhtempo_value"] = $value;
	//	multiple - 
			$viewContainer->recId = $recordsCounter;
	...
	//	jalan_kelas_id - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("jalan_kelas_id", $data, $keylink);
			$row["jalan_kelas_id_value"] = $value;
	//	tmt - Short Date
			$viewContainer->recId = $recordsCounter;
