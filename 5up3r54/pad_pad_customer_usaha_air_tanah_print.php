...
$layout->blocks["top"][] = "pdf";$page_layouts["pad_pad_customer_usaha_air_tanah_print"] = $layout;
...
$arr = array();
$arr['fName'] = "sumur_ke";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("sumur_ke");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "sipa_no";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("sipa_no");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "max_volume";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("max_volume");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "disabled";
...
//	customer_usaha_id - 
			$record["customer_usaha_id_value"] = $pageObject->showDBValue("customer_usaha_id", $data, $keylink);
			$record["customer_usaha_id_class"] = $pageObject->fieldClass("customer_usaha_id");
//	sumur_ke - 
			$record["sumur_ke_value"] = $pageObject->showDBValue("sumur_ke", $data, $keylink);
			$record["sumur_ke_class"] = $pageObject->fieldClass("sumur_ke");
//	sipa_no - 
			$record["sipa_no_value"] = $pageObject->showDBValue("sipa_no", $data, $keylink);
			$record["sipa_no_class"] = $pageObject->fieldClass("sipa_no");
//	max_volume - 
			$record["max_volume_value"] = $pageObject->showDBValue("max_volume", $data, $keylink);
			$record["max_volume_class"] = $pageObject->fieldClass("max_volume");
//	disabled - 
...
$xt->assign("customer_usaha_id_fieldheadercolumn",true);
$xt->assign("customer_usaha_id_fieldheader",true);
$xt->assign("customer_usaha_id_fieldcolumn",true);
$xt->assign("customer_usaha_id_fieldfootercolumn",true);
$xt->assign("sumur_ke_fieldheadercolumn",true);
$xt->assign("sumur_ke_fieldheader",true);
$xt->assign("sumur_ke_fieldcolumn",true);
$xt->assign("sumur_ke_fieldfootercolumn",true);
$xt->assign("sipa_no_fieldheadercolumn",true);
$xt->assign("sipa_no_fieldheader",true);
$xt->assign("sipa_no_fieldcolumn",true);
$xt->assign("sipa_no_fieldfootercolumn",true);
$xt->assign("max_volume_fieldheadercolumn",true);
$xt->assign("max_volume_fieldheader",true);
$xt->assign("max_volume_fieldcolumn",true);
$xt->assign("max_volume_fieldfootercolumn",true);
