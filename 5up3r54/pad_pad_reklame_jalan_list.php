...
$layout->blocks["top"][] = "search";$page_layouts["pad_pad_reklame_jalan_list"] = $layout;
...
$viewControls = new ViewControlsContainer(new ProjectSettings("pad.pad_reklame_kelas_jalan", PAGE_LIST), PAGE_LIST);
