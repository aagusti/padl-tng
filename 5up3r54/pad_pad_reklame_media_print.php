...
$layout->blocks["top"][] = "pdf";$page_layouts["pad_pad_reklame_media_print"] = $layout;
...
//	jenis_pajak_id - 
			$record["jenis_pajak_id_value"] = $pageObject->showDBValue("jenis_pajak_id", $data, $keylink);
			$record["jenis_pajak_id_class"] = $pageObject->fieldClass("jenis_pajak_id");
//	media - 
			$record["media_value"] = $pageObject->showDBValue("media", $data, $keylink);
			$record["media_class"] = $pageObject->fieldClass("media");
//	singkatan - 
			$record["singkatan_value"] = $pageObject->showDBValue("singkatan", $data, $keylink);
			$record["singkatan_class"] = $pageObject->fieldClass("singkatan");
//	masa - 
			$record["masa_value"] = $pageObject->showDBValue("masa", $data, $keylink);
			$record["masa_class"] = $pageObject->fieldClass("masa");
//	keterangan - 
...
$xt->assign("jenis_pajak_id_fieldheadercolumn",true);
$xt->assign("jenis_pajak_id_fieldheader",true);
$xt->assign("jenis_pajak_id_fieldcolumn",true);
$xt->assign("jenis_pajak_id_fieldfootercolumn",true);
$xt->assign("media_fieldheadercolumn",true);
$xt->assign("media_fieldheader",true);
$xt->assign("media_fieldcolumn",true);
$xt->assign("media_fieldfootercolumn",true);
$xt->assign("singkatan_fieldheadercolumn",true);
$xt->assign("singkatan_fieldheader",true);
$xt->assign("singkatan_fieldcolumn",true);
$xt->assign("singkatan_fieldfootercolumn",true);
$xt->assign("masa_fieldheadercolumn",true);
$xt->assign("masa_fieldheader",true);
$xt->assign("masa_fieldcolumn",true);
$xt->assign("masa_fieldfootercolumn",true);
