...
$layout->blocks["top"][] = "details";$page_layouts["pad_pad_reklame_kelas_jalan_view"] = $layout;
...
$arr = array();
$arr['fName'] = "nilai";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("nilai");
$fieldsArr[] = $arr;
$arr = array();
...
$arr = array();
$arr['fName'] = "kriteria";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("kriteria");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "enabled";
...
//nilai - Number
	...
	if($mainTableOwnerID=="nilai")
		$ownerIdValue=$value;
	$xt->assign("nilai_value",$value);
...
//kriteria - 
	...
	if($mainTableOwnerID=="kriteria")
		$ownerIdValue=$value;
	$xt->assign("kriteria_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pad_pad_reklame_kelas_jalan_edit.php?".$editlink."'\"");
