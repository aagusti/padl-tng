...
$layout->blocks["top"][] = "export";$page_layouts["public_tmp_bank_2013_export"] = $layout;
...
$xt->display("public_tmp_bank_2013_export.htm");

function ExportToExcel_old($cipherer)
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=public_tmp_bank_2013.xls");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=public_tmp_bank_2013.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=public_tmp_bank_2013.xml");
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=public_tmp_bank_2013.csv");
