...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["pad_pad_reklame_jalan_detailspreview"] = $layout;
...
{
	$where = "";
		$where .= GetFullFieldName("jalan_kelas_id", $strTableName, false)."=".make_db_value("jalan_kelas_id",$_SESSION[$strTableName."_masterkey1"]);
}
