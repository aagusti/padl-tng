...
$layout->blocks["top"][] = "details";$page_layouts["pad_pad_kohir_view"] = $layout;
...
$arr = array();
$arr['fName'] = "kohirno";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("kohirno");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "kohirtgl";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("kohirtgl");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "spt_id";
...
//kohirno - 
	...
	if($mainTableOwnerID=="kohirno")
		$ownerIdValue=$value;
	$xt->assign("kohirno_value",$value);
...
//kohirtgl - Short Date
	...
	if($mainTableOwnerID=="kohirtgl")
		$ownerIdValue=$value;
	$xt->assign("kohirtgl_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pad_pad_kohir_edit.php?".$editlink."'\"");
