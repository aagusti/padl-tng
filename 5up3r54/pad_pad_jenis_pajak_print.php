...
$layout->blocks["top"][] = "pdf";$page_layouts["pad_pad_jenis_pajak_print"] = $layout;
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "rekening_kd_sub";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("rekening_kd_sub");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "rekdenda_id";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("rekdenda_id");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "masapajak";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("masapajak");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "jatuhtempo";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("jatuhtempo");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "multiple";
...
//	rekening_kd_sub - 
			$record["rekening_kd_sub_value"] = $pageObject->showDBValue("rekening_kd_sub", $data, $keylink);
			$record["rekening_kd_sub_class"] = $pageObject->fieldClass("rekening_kd_sub");
//	rekdenda_id - 
			$record["rekdenda_id_value"] = $pageObject->showDBValue("rekdenda_id", $data, $keylink);
			$record["rekdenda_id_class"] = $pageObject->fieldClass("rekdenda_id");
//	masapajak - 
			$record["masapajak_value"] = $pageObject->showDBValue("masapajak", $data, $keylink);
			$record["masapajak_class"] = $pageObject->fieldClass("masapajak");
//	jatuhtempo - 
			$record["jatuhtempo_value"] = $pageObject->showDBValue("jatuhtempo", $data, $keylink);
			$record["jatuhtempo_class"] = $pageObject->fieldClass("jatuhtempo");
//	multiple - 
			$record["multiple_value"] = $pageObject->showDBValue("multiple", $data, $keylink);
			$record["multiple_class"] = $pageObject->fieldClass("multiple");
//	jalan_kelas_id - 
...
//	include proper masterprint.php code
	...
	$params = array("detailtable"=>"pad.pad_jenis_pajak","keys"=>$masterkeys);
	$master = array();
...
$xt->assign("rekening_kd_sub_fieldheadercolumn",true);
$xt->assign("rekening_kd_sub_fieldheader",true);
$xt->assign("rekening_kd_sub_fieldcolumn",true);
$xt->assign("rekening_kd_sub_fieldfootercolumn",true);
$xt->assign("rekdenda_id_fieldheadercolumn",true);
$xt->assign("rekdenda_id_fieldheader",true);
$xt->assign("rekdenda_id_fieldcolumn",true);
$xt->assign("rekdenda_id_fieldfootercolumn",true);
$xt->assign("masapajak_fieldheadercolumn",true);
$xt->assign("masapajak_fieldheader",true);
$xt->assign("masapajak_fieldcolumn",true);
$xt->assign("masapajak_fieldfootercolumn",true);
$xt->assign("jatuhtempo_fieldheadercolumn",true);
$xt->assign("jatuhtempo_fieldheader",true);
$xt->assign("jatuhtempo_fieldcolumn",true);
$xt->assign("jatuhtempo_fieldfootercolumn",true);
$xt->assign("multiple_fieldheadercolumn",true);
$xt->assign("multiple_fieldheader",true);
$xt->assign("multiple_fieldcolumn",true);
$xt->assign("multiple_fieldfootercolumn",true);
