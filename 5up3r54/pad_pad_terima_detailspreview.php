...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["pad_pad_terima_detailspreview"] = $layout;
...
if($rowcount) {
	...
	//	terimano - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("terimano", $data, $keylink);
			$row["terimano_value"] = $value;
	...
	//	jmlterima - Number
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("jmlterima", $data, $keylink);
			$row["jmlterima_value"] = $value;
	//	customer_id - 
			$viewContainer->recId = $recordsCounter;
	...
	//	nobukti - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("nobukti", $data, $keylink);
			$row["nobukti_value"] = $value;
	//	notes - 
			$viewContainer->recId = $recordsCounter;
