...
$layout->blocks["top"][] = "details";$page_layouts["pad_pad_air_hda_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pad_pad_air_hda_edit.php?".$editlink."'\"");
