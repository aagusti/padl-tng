...
$layout->blocks["top"][] = "details";$page_layouts["pad_pad_spt_reklame_view"] = $layout;
...
//spt_id - 
	...
	if($mainTableOwnerID=="spt_id")
		$ownerIdValue=$value;
	$xt->assign("spt_id_value",$value);
...
//media_id - 
	...
	if($mainTableOwnerID=="media_id")
		$ownerIdValue=$value;
	$xt->assign("media_id_value",$value);
...
//kelas_jalan_id - 
	...
	if($mainTableOwnerID=="kelas_jalan_id")
		$ownerIdValue=$value;
	$xt->assign("kelas_jalan_id_value",$value);
...
//panjang - Number
	...
	if($mainTableOwnerID=="panjang")
		$ownerIdValue=$value;
	$xt->assign("panjang_value",$value);
...
//lebar - Number
	...
	if($mainTableOwnerID=="lebar")
		$ownerIdValue=$value;
	$xt->assign("lebar_value",$value);
...
//tinggi - Number
	...
	if($mainTableOwnerID=="tinggi")
		$ownerIdValue=$value;
	$xt->assign("tinggi_value",$value);
...
//muka - 
	...
	if($mainTableOwnerID=="muka")
		$ownerIdValue=$value;
	$xt->assign("muka_value",$value);
...
//sisi - 
	...
	if($mainTableOwnerID=="sisi")
		$ownerIdValue=$value;
	$xt->assign("sisi_value",$value);
...
//banyak - 
	...
	if($mainTableOwnerID=="banyak")
		$ownerIdValue=$value;
	$xt->assign("banyak_value",$value);
...
//lama - 
	...
	if($mainTableOwnerID=="lama")
		$ownerIdValue=$value;
	$xt->assign("lama_value",$value);
...
//nsr - Number
	...
	if($mainTableOwnerID=="nsr")
		$ownerIdValue=$value;
	$xt->assign("nsr_value",$value);
...
//status_baliho - 
	...
	if($mainTableOwnerID=="status_baliho")
		$ownerIdValue=$value;
	$xt->assign("status_baliho_value",$value);
...
//tambahan - Number
	...
	if($mainTableOwnerID=="tambahan")
		$ownerIdValue=$value;
	$xt->assign("tambahan_value",$value);
...
//jalan_id - 
	...
	if($mainTableOwnerID=="jalan_id")
		$ownerIdValue=$value;
	$xt->assign("jalan_id_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pad_pad_spt_reklame_edit.php?".$editlink."'\"");
