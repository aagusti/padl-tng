...
$layout->blocks["top"][] = "details";$page_layouts["pad_pad_terima_view"] = $layout;
...
//terimano - 
	...
	if($mainTableOwnerID=="terimano")
		$ownerIdValue=$value;
	$xt->assign("terimano_value",$value);
...
//jmlterima - Number
	...
	if($mainTableOwnerID=="jmlterima")
		$ownerIdValue=$value;
	$xt->assign("jmlterima_value",$value);
...
//nobukti - 
	...
	if($mainTableOwnerID=="nobukti")
		$ownerIdValue=$value;
	$xt->assign("nobukti_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pad_pad_terima_edit.php?".$editlink."'\"");
