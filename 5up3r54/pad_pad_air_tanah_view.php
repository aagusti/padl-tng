...
$layout->blocks["top"][] = "details";$page_layouts["pad_pad_air_tanah_view"] = $layout;
...
$arr = array();
$arr['fName'] = "awal";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("awal");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "akhir";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("akhir");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "volume";
...
//sumur_ke - 
	...
	if($mainTableOwnerID=="sumur_ke")
		$ownerIdValue=$value;
	$xt->assign("sumur_ke_value",$value);
...
//sipa_no - 
	...
	if($mainTableOwnerID=="sipa_no")
		$ownerIdValue=$value;
	$xt->assign("sipa_no_value",$value);
...
//awal - Number
	...
	if($mainTableOwnerID=="awal")
		$ownerIdValue=$value;
	$xt->assign("awal_value",$value);
...
//akhir - Number
	...
	if($mainTableOwnerID=="akhir")
		$ownerIdValue=$value;
	$xt->assign("akhir_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pad_pad_air_tanah_edit.php?".$editlink."'\"");
