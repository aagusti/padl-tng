...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["app_group_modules_detailspreview"] = $layout;
...
if($mastertable == "app.modules")
{
	$where = "";
		$where .= GetFullFieldName("module_id", $strTableName, false)."=".make_db_value("module_id",$_SESSION[$strTableName."_masterkey1"]);
}
...
if($rowcount) {
	...
	//	module_id - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("module_id", $data, $keylink);
			$row["module_id_value"] = $value;
	//	reads - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("reads", $data, $keylink);
			$row["reads_value"] = $value;
	//	writes - 
			$viewContainer->recId = $recordsCounter;
