...
$layout->blocks["top"][] = "details";$page_layouts["pad_pad_spt_type_view"] = $layout;
...
$arr = array();
$arr['fName'] = "typenm";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("typenm");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "tmt";
...
//typenm - 
	...
	if($mainTableOwnerID=="typenm")
		$ownerIdValue=$value;
	$xt->assign("typenm_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pad_pad_spt_type_edit.php?".$editlink."'\"");
