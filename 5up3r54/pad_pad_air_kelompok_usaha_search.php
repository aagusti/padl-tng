...
include("include/pad_pad_air_kelompok_usaha_variables.php");
...
$layout->blocks["top"][] = "search";$page_layouts["pad_pad_air_kelompok_usaha_search"] = $layout;
...
$mode = SEARCH_SIMPLE;
$templatefile = "pad_pad_air_kelompok_usaha_search.htm";
...
$params['shortTableName'] = 'pad_pad_air_kelompok_usaha';
...
if ($mode==SEARCH_SIMPLE)
{
	...
	if($pageObject->pSet->getLookupTable("induk_id"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("induk_id")] = GetTableURL($pageObject->pSet->getLookupTable("induk_id"));
	
	$pageObject->fillFieldToolTips("induk_id");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("induk_id");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "induk_id";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("induk_id_label","<label for=\"".GetInputElementId("induk_id", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("induk_id_label", true);
	
	$xt->assign("induk_id_fieldblock", true);
	$xt->assignbyref("induk_id_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("induk_id_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("induk_id_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_induk_id", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("induk_id");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"induk_id", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"induk_id", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
	...
	if($pageObject->pSet->getLookupTable("id_old1"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("id_old1")] = GetTableURL($pageObject->pSet->getLookupTable("id_old1"));
	
	$pageObject->fillFieldToolTips("id_old1");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("id_old1");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "id_old1";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("id_old1_label","<label for=\"".GetInputElementId("id_old1", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("id_old1_label", true);
	
	$xt->assign("id_old1_fieldblock", true);
	$xt->assignbyref("id_old1_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("id_old1_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("id_old1_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_id_old1", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("id_old1");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"id_old1", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"id_old1", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
	
	if($pageObject->pSet->getLookupTable("id_old2"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("id_old2")] = GetTableURL($pageObject->pSet->getLookupTable("id_old2"));
	
	$pageObject->fillFieldToolTips("id_old2");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("id_old2");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "id_old2";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("id_old2_label","<label for=\"".GetInputElementId("id_old2", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("id_old2_label", true);
	
	$xt->assign("id_old2_fieldblock", true);
	$xt->assignbyref("id_old2_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("id_old2_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("id_old2_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_id_old2", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("id_old2");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"id_old2", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"id_old2", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
	
	if($pageObject->pSet->getLookupTable("id_old3"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("id_old3")] = GetTableURL($pageObject->pSet->getLookupTable("id_old3"));
	
	$pageObject->fillFieldToolTips("id_old3");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("id_old3");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "id_old3";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("id_old3_label","<label for=\"".GetInputElementId("id_old3", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("id_old3_label", true);
	
	$xt->assign("id_old3_fieldblock", true);
	$xt->assignbyref("id_old3_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("id_old3_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("id_old3_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_id_old3", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("id_old3");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"id_old3", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"id_old3", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
