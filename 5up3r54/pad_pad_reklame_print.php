...
$layout->blocks["top"][] = "pdf";$page_layouts["pad_pad_reklame_print"] = $layout;
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "pemilik_nama";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("pemilik_nama");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "pemilik_alamat";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("pemilik_alamat");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "pemilik_kecamatan";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("pemilik_kecamatan");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "pemilik_kelurahan";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("pemilik_kelurahan");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "pemilik_kota";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("pemilik_kota");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "updated";
...
//	pemilik_nama - 
			$record["pemilik_nama_value"] = $pageObject->showDBValue("pemilik_nama", $data, $keylink);
			$record["pemilik_nama_class"] = $pageObject->fieldClass("pemilik_nama");
//	pemilik_alamat - 
			$record["pemilik_alamat_value"] = $pageObject->showDBValue("pemilik_alamat", $data, $keylink);
			$record["pemilik_alamat_class"] = $pageObject->fieldClass("pemilik_alamat");
//	pemilik_kecamatan - 
			$record["pemilik_kecamatan_value"] = $pageObject->showDBValue("pemilik_kecamatan", $data, $keylink);
			$record["pemilik_kecamatan_class"] = $pageObject->fieldClass("pemilik_kecamatan");
//	pemilik_kelurahan - 
			$record["pemilik_kelurahan_value"] = $pageObject->showDBValue("pemilik_kelurahan", $data, $keylink);
			$record["pemilik_kelurahan_class"] = $pageObject->fieldClass("pemilik_kelurahan");
//	pemilik_kota - 
			$record["pemilik_kota_value"] = $pageObject->showDBValue("pemilik_kota", $data, $keylink);
			$record["pemilik_kota_class"] = $pageObject->fieldClass("pemilik_kota");
//	updated - Short Date
...
$xt->assign("pemilik_nama_fieldheadercolumn",true);
$xt->assign("pemilik_nama_fieldheader",true);
$xt->assign("pemilik_nama_fieldcolumn",true);
$xt->assign("pemilik_nama_fieldfootercolumn",true);
$xt->assign("pemilik_alamat_fieldheadercolumn",true);
$xt->assign("pemilik_alamat_fieldheader",true);
$xt->assign("pemilik_alamat_fieldcolumn",true);
$xt->assign("pemilik_alamat_fieldfootercolumn",true);
$xt->assign("pemilik_kecamatan_fieldheadercolumn",true);
$xt->assign("pemilik_kecamatan_fieldheader",true);
$xt->assign("pemilik_kecamatan_fieldcolumn",true);
$xt->assign("pemilik_kecamatan_fieldfootercolumn",true);
$xt->assign("pemilik_kelurahan_fieldheadercolumn",true);
$xt->assign("pemilik_kelurahan_fieldheader",true);
$xt->assign("pemilik_kelurahan_fieldcolumn",true);
$xt->assign("pemilik_kelurahan_fieldfootercolumn",true);
$xt->assign("pemilik_kota_fieldheadercolumn",true);
$xt->assign("pemilik_kota_fieldheader",true);
$xt->assign("pemilik_kota_fieldcolumn",true);
$xt->assign("pemilik_kota_fieldfootercolumn",true);
