...
$layout->blocks["top"][] = "details";$page_layouts["pad_units_view"] = $layout;
...
//singkat - 
	...
	if($mainTableOwnerID=="singkat")
		$ownerIdValue=$value;
	$xt->assign("singkat_value",$value);
...
//urusan_id - 
	...
	if($mainTableOwnerID=="urusan_id")
		$ownerIdValue=$value;
	$xt->assign("urusan_id_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pad_units_edit.php?".$editlink."'\"");
