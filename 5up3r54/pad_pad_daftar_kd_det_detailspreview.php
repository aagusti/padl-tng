...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["pad_pad_daftar_kd_det_detailspreview"] = $layout;
...
{
	$where = "";
		$where .= GetFullFieldName("daftar_id", $strTableName, false)."=".make_db_value("daftar_id",$_SESSION[$strTableName."_masterkey1"]);
}
...
if($rowcount) {
	...
	//	nourut - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("nourut", $data, $keylink);
			$row["nourut_value"] = $value;
	//	notes - 
			$viewContainer->recId = $recordsCounter;
	...
	//	kamar - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("kamar", $data, $keylink);
			$row["kamar_value"] = $value;
	//	volume - 
			$viewContainer->recId = $recordsCounter;
...
$xt->load_template("pad_pad_daftar_kd_det_detailspreview.htm");
