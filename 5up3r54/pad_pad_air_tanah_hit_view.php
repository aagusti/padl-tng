...
$layout->blocks["top"][] = "details";$page_layouts["pad_pad_air_tanah_hit_view"] = $layout;
...
$arr = array();
$arr['fName'] = "vol";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("vol");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "hda";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("hda");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "jumlah";
...
//vol - Number
	...
	if($mainTableOwnerID=="vol")
		$ownerIdValue=$value;
	$xt->assign("vol_value",$value);
...
//hda - Number
	...
	if($mainTableOwnerID=="hda")
		$ownerIdValue=$value;
	$xt->assign("hda_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pad_pad_air_tanah_hit_edit.php?".$editlink."'\"");
