...
$layout->blocks["top"][] = "details";$page_layouts["pad_pad_pegawai_view"] = $layout;
...
$arr = array();
$arr['fName'] = "pangkat";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("pangkat");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "tmt";
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "nomor_telp";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("nomor_telp");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "bagian";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("bagian");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "created";
...
//pangkat - 
	...
	if($mainTableOwnerID=="pangkat")
		$ownerIdValue=$value;
	$xt->assign("pangkat_value",$value);
...
//nomor_telp - 
	...
	if($mainTableOwnerID=="nomor_telp")
		$ownerIdValue=$value;
	$xt->assign("nomor_telp_value",$value);
...
//bagian - 
	...
	if($mainTableOwnerID=="bagian")
		$ownerIdValue=$value;
	$xt->assign("bagian_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pad_pad_pegawai_edit.php?".$editlink."'\"");
