...
$layout->blocks["top"][] = "details";$page_layouts["pad_user_pad_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pad_user_pad_edit.php?".$editlink."'\"");
