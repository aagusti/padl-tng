...
$layout->blocks["top"][] = "export";$page_layouts["pad_pad_reklame_sudut_pandang_export"] = $layout;
...
$xt->display("pad_pad_reklame_sudut_pandang_export.htm");

function ExportToExcel_old($cipherer)
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=pad_pad_reklame_sudut_pandang.xls");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=pad_pad_reklame_sudut_pandang.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=pad_pad_reklame_sudut_pandang.xml");
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=pad_pad_reklame_sudut_pandang.csv");
