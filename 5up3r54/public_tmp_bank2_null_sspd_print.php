...
$layout->blocks["top"][] = "pdf";$page_layouts["public_tmp_bank2_null_sspd_print"] = $layout;
...
$arr = array();
$arr['fName'] = "judul";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("judul");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "lokasi";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("lokasi");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "j";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("j");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "p";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("p");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "l";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("l");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "t";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("t");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "sspd_id";
...
//	judul - 
			$record["judul_value"] = $pageObject->showDBValue("judul", $data, $keylink);
			$record["judul_class"] = $pageObject->fieldClass("judul");
//	lokasi - 
			$record["lokasi_value"] = $pageObject->showDBValue("lokasi", $data, $keylink);
			$record["lokasi_class"] = $pageObject->fieldClass("lokasi");
//	j - Number
			$record["j_value"] = $pageObject->showDBValue("j", $data, $keylink);
			$record["j_class"] = $pageObject->fieldClass("j");
//	p - Number
			$record["p_value"] = $pageObject->showDBValue("p", $data, $keylink);
			$record["p_class"] = $pageObject->fieldClass("p");
//	l - Number
			$record["l_value"] = $pageObject->showDBValue("l", $data, $keylink);
			$record["l_class"] = $pageObject->fieldClass("l");
//	t - Number
			$record["t_value"] = $pageObject->showDBValue("t", $data, $keylink);
			$record["t_class"] = $pageObject->fieldClass("t");
//	sspd_id - 
...
$xt->assign("judul_fieldheadercolumn",true);
$xt->assign("judul_fieldheader",true);
$xt->assign("judul_fieldcolumn",true);
$xt->assign("judul_fieldfootercolumn",true);
$xt->assign("lokasi_fieldheadercolumn",true);
$xt->assign("lokasi_fieldheader",true);
$xt->assign("lokasi_fieldcolumn",true);
$xt->assign("lokasi_fieldfootercolumn",true);
$xt->assign("j_fieldheadercolumn",true);
$xt->assign("j_fieldheader",true);
$xt->assign("j_fieldcolumn",true);
$xt->assign("j_fieldfootercolumn",true);
$xt->assign("p_fieldheadercolumn",true);
$xt->assign("p_fieldheader",true);
$xt->assign("p_fieldcolumn",true);
$xt->assign("p_fieldfootercolumn",true);
$xt->assign("l_fieldheadercolumn",true);
$xt->assign("l_fieldheader",true);
$xt->assign("l_fieldcolumn",true);
$xt->assign("l_fieldfootercolumn",true);
$xt->assign("t_fieldheadercolumn",true);
$xt->assign("t_fieldheader",true);
$xt->assign("t_fieldcolumn",true);
$xt->assign("t_fieldfootercolumn",true);
