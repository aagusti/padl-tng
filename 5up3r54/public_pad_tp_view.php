...
$layout->blocks["top"][] = "details";$page_layouts["public_pad_tp_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='public_pad_tp_edit.php?".$editlink."'\"");
