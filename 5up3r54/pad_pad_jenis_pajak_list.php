...
include_once("include/pad_pad_tarif_pajak_settings.php");
include_once("include/pad_pad_terima_line_settings.php");
...
$layout->blocks["top"][] = "search";$page_layouts["pad_pad_jenis_pajak_list"] = $layout;
