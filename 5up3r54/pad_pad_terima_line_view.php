...
$layout->blocks["top"][] = "details";$page_layouts["pad_pad_terima_line_view"] = $layout;
...
if (!sizeof($data)) {
	header("Location: pad_pad_terima_line_list.php?a=return");
	exit();
}
...
//terima_id - 
	...
	if($mainTableOwnerID=="terima_id")
		$ownerIdValue=$value;
	$xt->assign("terima_id_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pad_pad_terima_line_edit.php?".$editlink."'\"");
