...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["app_user_groups_detailspreview"] = $layout;
...
if($mastertable == "app.groups")
{
	$where = "";
		$where .= GetFullFieldName("group_id", $strTableName, false)."=".make_db_value("group_id",$_SESSION[$strTableName."_masterkey1"]);
}
if($mastertable == "app.users")
{
	$where = "";
		$where .= GetFullFieldName("user_id", $strTableName, false)."=".make_db_value("user_id",$_SESSION[$strTableName."_masterkey1"]);
}
