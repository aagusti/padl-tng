...
$layout->blocks["top"][] = "pdf";$page_layouts["pad_pad_daftar_status_print"] = $layout;
...
//	uraian - 
			$record["uraian_value"] = $pageObject->showDBValue("uraian", $data, $keylink);
			$record["uraian_class"] = $pageObject->fieldClass("uraian");
			if($col<$colsonpage)
...
$xt->assign("uraian_fieldheadercolumn",true);
$xt->assign("uraian_fieldheader",true);
$xt->assign("uraian_fieldcolumn",true);
$xt->assign("uraian_fieldfootercolumn",true);
