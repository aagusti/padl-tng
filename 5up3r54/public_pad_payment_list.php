...
$layout->blocks["top"][] = "search";$page_layouts["public_pad_payment_list"] = $layout;
...
$viewControls = new ViewControlsContainer(new ProjectSettings("pad.pad_sspd", PAGE_LIST), PAGE_LIST);
