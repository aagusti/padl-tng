...
$layout->blocks["top"][] = "details";$page_layouts["pad_pad_air_kelompok_usaha_view"] = $layout;
...
$arr = array();
$arr['fName'] = "induk_id";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("induk_id");
$fieldsArr[] = $arr;
$arr = array();
...
$arr = array();
$arr['fName'] = "id_old1";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("id_old1");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "id_old2";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("id_old2");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "id_old3";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("id_old3");
$fieldsArr[] = $arr;
...
//induk_id - 
	...
	if($mainTableOwnerID=="induk_id")
		$ownerIdValue=$value;
	$xt->assign("induk_id_value",$value);
...
//id_old1 - 
	...
	if($mainTableOwnerID=="id_old1")
		$ownerIdValue=$value;
	$xt->assign("id_old1_value",$value);
...
//id_old2 - 
	...
	if($mainTableOwnerID=="id_old2")
		$ownerIdValue=$value;
	$xt->assign("id_old2_value",$value);
...
//id_old3 - 
	...
	if($mainTableOwnerID=="id_old3")
		$ownerIdValue=$value;
	$xt->assign("id_old3_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pad_pad_air_kelompok_usaha_edit.php?".$editlink."'\"");
