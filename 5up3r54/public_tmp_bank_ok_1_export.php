...
include("include/public_tmp_bank_ok_1_variables.php");
...
$layout->blocks["top"][] = "export";$page_layouts["public_tmp_bank_ok_1_export"] = $layout;
...
$xt->display("public_tmp_bank_ok_1_export.htm");

function ExportToExcel_old($cipherer)
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=public_tmp_bank_ok_1.xls");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=public_tmp_bank_ok_1.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=public_tmp_bank_ok_1.xml");
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=public_tmp_bank_ok_1.csv");
