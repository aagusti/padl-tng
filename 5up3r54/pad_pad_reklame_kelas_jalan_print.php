...
$layout->blocks["top"][] = "pdf";$page_layouts["pad_pad_reklame_kelas_jalan_print"] = $layout;
...
//	nilai - Number
			$record["nilai_value"] = $pageObject->showDBValue("nilai", $data, $keylink);
			$record["nilai_class"] = $pageObject->fieldClass("nilai");
//	update_uid - 
...
//	kriteria - 
			$record["kriteria_value"] = $pageObject->showDBValue("kriteria", $data, $keylink);
			$record["kriteria_class"] = $pageObject->fieldClass("kriteria");
//	enabled - 
...
$xt->assign("nilai_fieldheadercolumn",true);
$xt->assign("nilai_fieldheader",true);
$xt->assign("nilai_fieldcolumn",true);
$xt->assign("nilai_fieldfootercolumn",true);
...
$xt->assign("kriteria_fieldheadercolumn",true);
$xt->assign("kriteria_fieldheader",true);
$xt->assign("kriteria_fieldcolumn",true);
$xt->assign("kriteria_fieldfootercolumn",true);
