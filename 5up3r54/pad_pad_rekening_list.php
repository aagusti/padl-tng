...
include_once("include/pad_pad_anggaran_settings.php");
include_once("include/pad_pad_jenis_pajak_settings.php");
...
$layout->blocks["top"][] = "search";$page_layouts["pad_pad_rekening_list"] = $layout;
