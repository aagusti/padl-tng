...
include_once("include/pad_pad_air_tanah_hit_settings.php");
include_once("include/pad_pad_stpd_settings.php");
...
$layout->blocks["top"][] = "search";$page_layouts["pad_pad_spt_list"] = $layout;
...
$viewControls = new ViewControlsContainer(new ProjectSettings("pad.pad_customer_usaha", PAGE_LIST), PAGE_LIST);
...
include_once getabspath('classes/controls/ViewControlsContainer.php');
$viewControls = new ViewControlsContainer(new ProjectSettings("pad.pad_spt_type", PAGE_LIST), PAGE_LIST);
$viewControls->addControlsJSAndCSS();
$pageObject->includes_js = array_merge($pageObject->includes_js, $viewControls->includes_js);
$pageObject->includes_jsreq = array_merge($pageObject->includes_jsreq, $viewControls->includes_jsreq);
$pageObject->includes_css = array_merge($pageObject->includes_css, $viewControls->includes_css);
