...
include_once("include/pad_pad_spt_settings.php");
include_once("include/pad_pad_customer_usaha_settings.php");
include_once("include/pad_pad_customer_detail_settings.php");
include_once("include/pad_pad_terima_settings.php");
...
$layout->blocks["top"][] = "search";$page_layouts["pad_pad_customer_list"] = $layout;
...
$viewControls = new ViewControlsContainer(new ProjectSettings("pad.pad_kecamatan", PAGE_LIST), PAGE_LIST);
...
$layout->skins["mastergrid"] = "grid";
$layout->blocks["bare"][] = "mastergrid";$page_layouts["pad_pad_kelurahan_masterlist"] = $layout;
