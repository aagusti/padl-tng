...
$layout->blocks["top"][] = "details";$page_layouts["pad_pad_tarif_pajak_view"] = $layout;
...
//reklame - Number
	...
	if($mainTableOwnerID=="reklame")
		$ownerIdValue=$value;
	$xt->assign("reklame_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pad_pad_tarif_pajak_edit.php?".$editlink."'\"");
