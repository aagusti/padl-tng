...
$layout->blocks["top"][] = "search";$page_layouts["pad_pad_terima_search"] = $layout;
...
$mode = SEARCH_SIMPLE;
$templatefile = "pad_pad_terima_search.htm";
...
$params['shortTableName'] = 'pad_pad_terima';
...
if ($mode==SEARCH_SIMPLE)
{
	...
	if($pageObject->pSet->getLookupTable("terimano"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("terimano")] = GetTableURL($pageObject->pSet->getLookupTable("terimano"));
	
	$pageObject->fillFieldToolTips("terimano");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("terimano");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "terimano";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("terimano_label","<label for=\"".GetInputElementId("terimano", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("terimano_label", true);
	
	$xt->assign("terimano_fieldblock", true);
	$xt->assignbyref("terimano_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("terimano_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("terimano_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_terimano", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("terimano");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"terimano", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"terimano", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
	...
	if($pageObject->pSet->getLookupTable("jmlterima"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("jmlterima")] = GetTableURL($pageObject->pSet->getLookupTable("jmlterima"));
	
	$pageObject->fillFieldToolTips("jmlterima");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("jmlterima");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "jmlterima";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("jmlterima_label","<label for=\"".GetInputElementId("jmlterima", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("jmlterima_label", true);
	
	$xt->assign("jmlterima_fieldblock", true);
	$xt->assignbyref("jmlterima_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("jmlterima_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("jmlterima_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_jmlterima", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("jmlterima");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"jmlterima", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"jmlterima", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
	...
	if($pageObject->pSet->getLookupTable("nobukti"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("nobukti")] = GetTableURL($pageObject->pSet->getLookupTable("nobukti"));
	
	$pageObject->fillFieldToolTips("nobukti");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("nobukti");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "nobukti";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("nobukti_label","<label for=\"".GetInputElementId("nobukti", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("nobukti_label", true);
	
	$xt->assign("nobukti_fieldblock", true);
	$xt->assignbyref("nobukti_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("nobukti_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("nobukti_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_nobukti", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("nobukti");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"nobukti", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"nobukti", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
