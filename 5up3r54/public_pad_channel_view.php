...
$layout->blocks["top"][] = "details";$page_layouts["public_pad_channel_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='public_pad_channel_edit.php?".$editlink."'\"");
