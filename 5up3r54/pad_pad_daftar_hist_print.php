...
$layout->blocks["top"][] = "pdf";$page_layouts["pad_pad_daftar_hist_print"] = $layout;
...
$arr = array();
$arr['fName'] = "daftar_id";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("daftar_id");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "status_id";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("status_id");
$fieldsArr[] = $arr;
$arr = array();
...
//	daftar_id - 
			$record["daftar_id_value"] = $pageObject->showDBValue("daftar_id", $data, $keylink);
			$record["daftar_id_class"] = $pageObject->fieldClass("daftar_id");
//	status_id - 
			$record["status_id_value"] = $pageObject->showDBValue("status_id", $data, $keylink);
			$record["status_id_class"] = $pageObject->fieldClass("status_id");
...
$layout->blocks["bare"][] = "mastergrid";$page_layouts["pad_pad_daftar_masterprint"] = $layout;
	...
	$layout = GetPageLayout("pad_pad_daftar", 'masterprint');
	if($layout)
	{
...
if($mastertable == "pad.pad_daftar_status")
{
//	include proper masterprint.php code
	include("include/pad_pad_daftar_status_masterprint.php");
	$masterkeys[] = @$_SESSION[$strTableName."_masterkey1"];
	$params = array("detailtable"=>"pad.pad_daftar_hist","keys"=>$masterkeys);
	$master = array();
...
$layout->skins["mastergrid"] = "grid";
$layout->blocks["bare"][] = "mastergrid";$page_layouts["pad_pad_daftar_status_masterprint"] = $layout;
...
$xt->assign("daftar_id_fieldheadercolumn",true);
$xt->assign("daftar_id_fieldheader",true);
$xt->assign("daftar_id_fieldcolumn",true);
$xt->assign("daftar_id_fieldfootercolumn",true);
$xt->assign("status_id_fieldheadercolumn",true);
$xt->assign("status_id_fieldheader",true);
$xt->assign("status_id_fieldcolumn",true);
$xt->assign("status_id_fieldfootercolumn",true);
