...
$layout->blocks["top"][] = "export";$page_layouts["pad_pad_reklame_nilai_strategis_export"] = $layout;
...
$xt->display("pad_pad_reklame_nilai_strategis_export.htm");

function ExportToExcel_old($cipherer)
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=pad_pad_reklame_nilai_strategis.xls");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=pad_pad_reklame_nilai_strategis.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=pad_pad_reklame_nilai_strategis.xml");
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=pad_pad_reklame_nilai_strategis.csv");
