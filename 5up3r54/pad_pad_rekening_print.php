...
$layout->blocks["top"][] = "pdf";$page_layouts["pad_pad_rekening_print"] = $layout;
...
//	levelid - 
			$record["levelid_value"] = $pageObject->showDBValue("levelid", $data, $keylink);
			$record["levelid_class"] = $pageObject->fieldClass("levelid");
//	issummary - 
			$record["issummary_value"] = $pageObject->showDBValue("issummary", $data, $keylink);
			$record["issummary_class"] = $pageObject->fieldClass("issummary");
//	defsign - 
			$record["defsign_value"] = $pageObject->showDBValue("defsign", $data, $keylink);
			$record["defsign_class"] = $pageObject->fieldClass("defsign");
//	isppkd - 
			$record["isppkd_value"] = $pageObject->showDBValue("isppkd", $data, $keylink);
			$record["isppkd_class"] = $pageObject->fieldClass("isppkd");
//	tmt - Short Date
...
//	insidentil - 
			$record["insidentil_value"] = $pageObject->showDBValue("insidentil", $data, $keylink);
			$record["insidentil_class"] = $pageObject->fieldClass("insidentil");
			if($col<$colsonpage)
...
$xt->assign("levelid_fieldheadercolumn",true);
$xt->assign("levelid_fieldheader",true);
$xt->assign("levelid_fieldcolumn",true);
$xt->assign("levelid_fieldfootercolumn",true);
$xt->assign("issummary_fieldheadercolumn",true);
$xt->assign("issummary_fieldheader",true);
$xt->assign("issummary_fieldcolumn",true);
$xt->assign("issummary_fieldfootercolumn",true);
$xt->assign("defsign_fieldheadercolumn",true);
$xt->assign("defsign_fieldheader",true);
$xt->assign("defsign_fieldcolumn",true);
$xt->assign("defsign_fieldfootercolumn",true);
$xt->assign("isppkd_fieldheadercolumn",true);
$xt->assign("isppkd_fieldheader",true);
$xt->assign("isppkd_fieldcolumn",true);
$xt->assign("isppkd_fieldfootercolumn",true);
...
$xt->assign("insidentil_fieldheadercolumn",true);
$xt->assign("insidentil_fieldheader",true);
$xt->assign("insidentil_fieldcolumn",true);
$xt->assign("insidentil_fieldfootercolumn",true);
