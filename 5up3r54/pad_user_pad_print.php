...
$layout->blocks["top"][] = "pdf";$page_layouts["pad_user_pad_print"] = $layout;
...
//	user_id - 
			$record["user_id_value"] = $pageObject->showDBValue("user_id", $data, $keylink);
			$record["user_id_class"] = $pageObject->fieldClass("user_id");
//	customer_id - 
...
$xt->assign("user_id_fieldheadercolumn",true);
$xt->assign("user_id_fieldheader",true);
$xt->assign("user_id_fieldcolumn",true);
$xt->assign("user_id_fieldfootercolumn",true);
