...
$layout->blocks["top"][] = "pdf";$page_layouts["pad_units_print"] = $layout;
...
$arr = array();
$arr['fName'] = "singkat";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("singkat");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "id";
...
$arr = array();
$arr['fName'] = "urusan_id";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("urusan_id");
$fieldsArr[] = $arr;
...
//	kategori - 
			$record["kategori_value"] = $pageObject->showDBValue("kategori", $data, $keylink);
			$record["kategori_class"] = $pageObject->fieldClass("kategori");
//	singkat - 
			$record["singkat_value"] = $pageObject->showDBValue("singkat", $data, $keylink);
			$record["singkat_class"] = $pageObject->fieldClass("singkat");
//	id - 
			$record["id_value"] = $pageObject->showDBValue("id", $data, $keylink);
			$record["id_class"] = $pageObject->fieldClass("id");
//	urusan_id - 
			$record["urusan_id_value"] = $pageObject->showDBValue("urusan_id", $data, $keylink);
			$record["urusan_id_class"] = $pageObject->fieldClass("urusan_id");
			if($col<$colsonpage)
...
$xt->assign("kategori_fieldheadercolumn",true);
$xt->assign("kategori_fieldheader",true);
$xt->assign("kategori_fieldcolumn",true);
$xt->assign("kategori_fieldfootercolumn",true);
$xt->assign("singkat_fieldheadercolumn",true);
$xt->assign("singkat_fieldheader",true);
$xt->assign("singkat_fieldcolumn",true);
$xt->assign("singkat_fieldfootercolumn",true);
...
$xt->assign("urusan_id_fieldheadercolumn",true);
$xt->assign("urusan_id_fieldheader",true);
$xt->assign("urusan_id_fieldcolumn",true);
$xt->assign("urusan_id_fieldfootercolumn",true);
