...
$layout->blocks["top"][] = "details";$page_layouts["public_tmp_bank_edit"] = $layout;
...
$templatefile = ($inlineedit == EDIT_INLINE) ? "public_tmp_bank_inline_edit.htm" : "public_tmp_bank_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: public_tmp_bank_".$pageObject->getPageType().".php?".$keyGetQ);
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='public_tmp_bank_view.php?".$viewlink."'\"");
