...
$layout->blocks["top"][] = "details";$page_layouts["pad_pad_daftar_hist_view"] = $layout;
...
//status_id - 
	...
	if($mainTableOwnerID=="status_id")
		$ownerIdValue=$value;
	$xt->assign("status_id_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pad_pad_daftar_hist_edit.php?".$editlink."'\"");
