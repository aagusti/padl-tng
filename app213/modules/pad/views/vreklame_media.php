...
$(document).ready(function() {	
	oTable = $('#table1').dataTable({
		...
		"aoColumnDefs": [			
			...
			{ "aTargets": [1], "bSearchable": true,  "bVisible": true,  "sWidth": "180px", "sClass": "" },
			...
			{ "aTargets": [6], "bSearchable": true,  "bVisible": true,  "sWidth": "80px", "sClass": "" },
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "<?=active_module_url();?>reklame_media/grid"
	}); 
	...
	$('#btn_tambah').click(function() {
		window.location = '<?=active_module_url();?>reklame_media/add/';
	});

	$('#btn_edit').click(function() {
		if(mID) {
			window.location = '<?=active_module_url();?>reklame_media/edit/'+mID;
		}else{
	...
	$('#btn_delete').click(function() {
		if(mID) {
			...
			if(hapus==true) {
				window.location = '<?=active_module_url();?>reklame_media/delete/'+mID;
			};
		}else{
