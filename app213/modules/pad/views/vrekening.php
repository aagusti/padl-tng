...
$(document).ready(function() {	
	oTable = $('#table1').dataTable({
		...
		"aoColumnDefs": [			
			...
			{ "aTargets": [7], "bSearchable": true,  "bVisible": true,  "sWidth": "80px", "sClass": "" },
			{ "aTargets": [8], "bSearchable": true,  "bVisible": true,  "sWidth": "60px", "sClass": "" },
		],
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "<?=active_module_url();?>rekening/grid"
	}); 
	...
	$('#btn_tambah').click(function() {
		window.location = '<?=active_module_url();?>rekening/add/';
	});

	$('#btn_edit').click(function() {
		if(mID) {
			window.location = '<?=active_module_url();?>rekening/edit/'+mID;
		}else{
	...
	$('#btn_delete').click(function() {
		if(mID) {
			...
			if(hapus==true) {
				window.location = '<?=active_module_url();?>rekening/delete/'+mID;
			};
		}else{
