...
$(document).ready(function() {	
	oTable = $('#table1').dataTable({
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "<?=active_module_url();?>air_manfaat/grid"
	}); 
	...
	$('#btn_tambah').click(function() {
		window.location = '<?=active_module_url();?>air_manfaat/add/';
	});

	$('#btn_edit').click(function() {
		if(mID) {
			window.location = '<?=active_module_url();?>air_manfaat/edit/'+mID;
		}else{
	...
	$('#btn_delete').click(function() {
		if(mID) {
			...
			if(hapus==true) {
				window.location = '<?=active_module_url();?>air_manfaat/delete/'+mID;
			};
		}else{
 ...
 <div class="content">  
	 <div class="container-fluid">  
		...
		<ul class="nav nav-tabs">
			<li class="active">
				<a href="#"><strong>AIR - MANFAAT</strong></a>
			</li>
		</ul>
