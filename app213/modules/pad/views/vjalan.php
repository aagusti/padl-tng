...
$(document).ready(function() {	
	oTable = $('#table1').dataTable({
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "<?=active_module_url();?>jalan/grid"
	}); 
	...
	$('#btn_tambah').click(function() {
		window.location = '<?=active_module_url();?>jalan/add/';
	});

	$('#btn_edit').click(function() {
		if(mID) {
			window.location = '<?=active_module_url();?>jalan/edit/'+mID;
		}else{
	...
	$('#btn_delete').click(function() {
		if(mID) {
			...
			if(hapus==true) {
				window.location = '<?=active_module_url();?>jalan/delete/'+mID;
			};
		}else{
 ...
 <div class="content">  
	 <div class="container-fluid">  
		...
		<ul class="nav nav-tabs">
			<li class="active">
				<a href="#"><strong>NAMA JALAN</strong></a>
			</li>
		</ul>
