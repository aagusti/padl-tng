...
$(document).ready(function() {	
	oTable = $('#table1').dataTable({
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "<?=active_module_url();?>air_sub_kelompok_usaha/grid/",
	}); 
	...
	var tb_array = [
		...
		'	<button id="btn_detail_kelompok_usaha" class="btn btn-success pull-left" type="button">Detail Kel. Usaha</button>',
	...
	$('#btn_tambah').click(function() {
		window.location = '<?=active_module_url();?>air_sub_kelompok_usaha/add/';
	});

	$('#btn_edit').click(function() {
		if(mID) {
			window.location = '<?=active_module_url();?>air_sub_kelompok_usaha/edit/'+mID;
		}else{
	...
	$('#btn_delete').click(function() {
		if(mID) {
			...
			if(hapus==true) {
				window.location = '<?=active_module_url();?>air_sub_kelompok_usaha/delete/'+mID;
			};
		}else{
	...
	$('#btn_detail_kelompok_usaha').click(function() {
		if(mID) {
			window.location = '<?=active_module_url();?>air_detail_kelompok_usaha/index/'+mID;
		}else{
		...
		<table class="table" id="table1">
			<thead>
				<tr>
					<th>index</th>
					<th>Kode</th>
					<th>Sub Kelompok Usaha</th>
					<th>Kelompok Usaha I</th>
