...
$(document).ready(function() {	
	oTable = $('#table1').dataTable({
		...
		"aoColumnDefs": [			
			...
			{ "aTargets": [5], "bSearchable": true,  "bVisible": true,  "sWidth": "100px", "sClass": "center" },
		],
	...
	var tb_array = [
		...
		'</div>',
		'<div class="btn-group pull-left">',
		'	<button id="btnshow_rpt" class="btn btn-primary" data-rpt="wpkartu">Cetak Kartu</button>',
		'	<button id="btnshow_rpt" class="btn btn-primary" data-rpt="wpkartu_backside">Cetak Back Side</button>',
		'	<button id="btnshow_rpt" class="btn btn-primary" data-rpt="wpkukuh">Cetak Pengukuhan</button>',
		'</div></br>',
	];
	...
	$('#btn_tambah').click(function() {
		window.location = '<?=active_module_url();?>subjek_pajak/add/';
	});

	$('#btn_edit').click(function() {
		if(mID) {
			window.location = '<?=active_module_url();?>subjek_pajak/edit/'+mID;
		}else{
	...
	$('#btn_delete').click(function() {
		if(mID) {
			...
			if(hapus==true) {
				window.location = '<?=active_module_url();?>subjek_pajak/delete/'+mID;
			};
		}else{
