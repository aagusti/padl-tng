...
$(document).ready(function() {
	$('#btn_cancel').click(function() {
		window.location = '<?=active_module_url();?>jalan';
	});
...
<div class="content">
    <div class="container-fluid">
		...
		<?php echo form_open($faction, array('id'=>'myform','class'=>'form-horizontal'));?><br>
			...
			<div class="form-group">
				<label class="control-label col-sm-2" for="nama">Nama Jalan</label>
				<div class="col-sm-4">
					<input class="form-control" type="text" name="nama" id="nama" value="<?=$dt['nama']?>" required />
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2" for="nama">Klas Jalan</label>
				<div class="col-sm-4">
					<?=$select_jalan_kelas;?>
				</div>
			</div>
