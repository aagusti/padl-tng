...
var global_end_loop;
	...
	function hitung_denda(bulantahun){
		...
		$('#denda').autoNumeric('set', 0);
		$('#pesandenda').html('(Terlambat ' + selisih_masa + ' Bulan)');
		$('#bulan_telat').val(selisih_masa);
				...
				<div class="row">
			 	<div class="row col-sm-5">	
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input class="form-control hide" type="text" style="text-align:right;" name="bulan_telat" id="bulan_telat" value="<?=$dt['bulan_telat']?>" readonly />
