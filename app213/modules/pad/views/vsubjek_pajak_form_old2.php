...
$('#btn_ath_new').click( function (e) {
	...
	var aiNew = oTableAT.fnAddData( [ sumur_ke , sipa_no,  max_volume, disabled,'<a class="delete" href="">Hapus</a>' ] );
	var nRow = oTableAT.fnGetNodes( aiNew[0] );

	$('#sumur_ke').val(sumur_ke+1);
	$('#sumur_ke').val(0);
	$('#sumur_ke').val(0);
	$('#sumur_ke').val(0);
});
			...
			<div class="" id="kd_air_tanah">
				<div class="row">
					...
					<h4><u>Data Air Tanah</u></h4>
						...
						<div id="gap_form">
							<div class="form-group">
								<label class="control-label col-sm-4">Sumur</label>
								<div class="col-sm-4">
									<input class="form-control" type="text" style="text-align:right;" name="sumur_ke" id="sumur_ke" />
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-sm-4">No. Sipa</label>
								<div class="col-sm-4">
									<input class="form-control" type="text" style="text-align:right;" name="sipa_no" id="sipa_no" value=0 />
								</div>
							</div>
							<div class="form-group">
