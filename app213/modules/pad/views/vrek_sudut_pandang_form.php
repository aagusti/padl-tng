...
$(document).ready(function() {
	$('#btn_cancel').click(function() {
		window.location = '<?=active_module_url();?>rek_sudut_pandang';
	});
    ...
    <div class="container-fluid">
		...
		<?php echo form_open($faction, array('id'=>'myform','class'=>'form-horizontal'));?>
			...
			<div class="control-group">
				<label class="control-label" for="sudutnm">Uraian</label>
				<div class="controls">
					<input class="input-xlarge" type="text" name="sudutnm" id="sudutnm" value="<?=$dt['sudutnm']?>" required />
				</div>
			</div>
			<div class="control-group">
