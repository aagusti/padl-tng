...
$(document).ready(function() {
	$('#btn_cancel').click(function() {
		window.location = '<?=active_module_url();?>rek_lokasi_pasang';
	});
    ...
    <div class="container-fluid">
		...
		<?php echo form_open($faction, array('id'=>'myform','class'=>'form-horizontal'));?>
			...
			<div class="control-group">
				<label class="control-label" for="lokasinm">Uraian</label>
				<div class="controls">
					<input class="input-xlarge" type="text" name="lokasinm" id="lokasinm" value="<?=$dt['lokasinm']?>" required />
				</div>
			</div>
			<div class="control-group">
