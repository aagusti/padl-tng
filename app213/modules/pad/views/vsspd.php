...
$(document).ready(function() {	
	...
	var tb_array = [
		...
		'	<button id="btn_batal_sspd" data-loading-text="Batal SSPD <img border=\'0\' src=\'<?=base_url('assets/pad/img/ajax-loader-fb-white.gif')?>\' />" class="btn btn-warning">Reversal</button>',
		'</div>',
        ...
        */
		'</div>',
		'<div class="btn-group pull-left" style="padding-right:4px;">',
		'	<button id="btnshow_rpt" class="btn btn-primary" data-rpt="sspd"><i class="fa fa-print"></i> Cetak</button>',
	...
	$('#btn_batal_sspd').click(function() {
		if(mID) {
			...
			if ( anSelected.length !== 0 ) {
				...
				if (data[1] != null) {
					var proses = confirm('Batalkan SSPD data ini? Pembayaran : '+nobayar);
					if(proses == true) {
						$(this).button('loading');
                        setTimeout(function() {
                            $.ajax({
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="dlgKategoriLabel">PROSES SSPD</h4>
            </div>
            <div class="content">
            <div class="box-body">
                <div class="form-group">
                    ...
                    <label class="control-label col-sm-3" for="sspdtgl">Tanggal Bayar</label>
                    <div class="col-sm-3">
                    ...
                    <label class="control-label col-sm-2" for="masa_sspd">Masa Pajak</label>
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-6">
                    <label>( Terlambat : &nbsp;</label><label id="telat_bulan"></label><label>&nbsp; Bulan )</label>
                    </div>
                    <div class="col-sm-12">
                    </div>
                    <label class="control-label col-sm-3" for="jumlah_sspd">Jumlah Dibayar</label>
                    <div class="col-sm-3">
                        <select class="form-control" id="jenis_bayar">
                        	<option value=2> Pokok + Denda</option>
                        	<option value=1> Pokok </option>
                        </select>
                    </div>
                    <div class="col-sm-3">
                        <input class="form-control" type="text" name="jumlah_sspd" id="jumlah_sspd" value="" placeholder="Jumlah Dibayar" readonly />
                    </div>
                    <div class="col-sm-12">
                    </div>
                    ...
                    <label class="control-label col-sm-3" for="petugas_id">Petugas Penerima</label>
                    <div class="col-sm-3">
                        <?=$select_petugas;?>
                    </div>
                    <div class="col-sm-12">
...
<!-- End Modal -->
	...
	<div class="container-fluid">  
		<ul class="nav nav-tabs">
			<li class="active">
				<a href="#"><strong>PENERIMAAN - PEMBAYARAN </strong></a>
			</li>
		</ul>
