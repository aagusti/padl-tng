...
$(document).ready(function() {	
	oTable = $('#table1').dataTable({
		...
		"aoColumnDefs": [			
			...
			{ "aTargets": [5], "bSearchable": true,  "bVisible": true,  "sWidth": "60px", "sClass": "right" },
			{ "aTargets": [6], "bSearchable": true,  "bVisible": true,  "sWidth": "60px", "sClass": "right" },
		],
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "<?=active_module_url();?>penerimaan/grid"
	}); 
	...
	$('#btn_tambah').click(function() {
		window.location = '<?=active_module_url();?>penerimaan/add/';
	});

	$('#btn_edit').click(function() {
		if(mID) {
			window.location = '<?=active_module_url();?>penerimaan/edit/'+mID;
		}else{
	...
	$('#btn_delete').click(function() {
		if(mID) {
			...
			if(hapus==true) {
				window.location = '<?=active_module_url();?>penerimaan/delete/'+mID;
			};
		}else{
