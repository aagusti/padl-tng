...
$(document).ready(function() {	
	oTable = $('#table1').dataTable({
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "<?=active_module_url();?>reklame_nilai_strategis/grid"
	}); 
	...
	$('#btn_tambah').click(function() {
		window.location = '<?=active_module_url();?>reklame_nilai_strategis/add/';
	});

	$('#btn_edit').click(function() {
		if(mID) {
			window.location = '<?=active_module_url();?>reklame_nilai_strategis/edit/'+mID;
		}else{
	...
	$('#btn_delete').click(function() {
		if(mID) {
			...
			if(hapus==true) {
				window.location = '<?=active_module_url();?>reklame_nilai_strategis/delete/'+mID;
			};
		}else{
 ...
 <div class="content">  
	 <div class="container-fluid">  
		...
		<ul class="nav nav-tabs">
			<li class="active">
				<a href="#"><strong>NILAI STRATEGIS REKLAME</strong></a>
			</li>
		</ul>
