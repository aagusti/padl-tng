...
$(document).ready(function() {
	$('#btn_cancel').click(function() {
		window.location = '<?=active_module_url();?>air_zona';
	});
	
	$('#indeks').autoNumeric('init', {
...
<div class="content">
    <div class="container-fluid">
		...
		<?php echo form_open($faction, array('id'=>'myform','class'=>'form-horizontal'));?><br>
			...
			<div class="form-group">
				<label class="control-label col-sm-1" for="indeks">Indeks</label>
				<div class="col-sm-4">
					<input class="form-control" type="text" name="indeks" id="indeks" value="<?=$dt['indeks']?>" style="text-align:right;" required />
				</div>
			</div>
			<hr />
