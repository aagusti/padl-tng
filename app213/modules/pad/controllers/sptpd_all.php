...
class sptpd_all extends CI_Controller {
    private $module = 'pendataan';
    private $controller = 'sptpd_all';
    ...
    public function index()
    {
        ...
        if (!wp_login()) {
            ...
            $this->load->view(active_module().'/vsptpd_all', $data);
        } else {
            $select_data = $this->load->model('sptpd_type_model')->get_select();
            $options     = array();
            if($select_data) {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            */
            ...
            $update_data = array(                
                ...
                /*
                'write_date' => date('Y-m-d', strtotime($input_post['write_date'])),
                'write_uid' => $input_post['write_uid'],
    ...
    function get_klas_jalan()
    {
        ...
        $model = $this->load->model('jalan_klas_model');
    ...
    function get_jalan_val()
    {
        ...
        if ($rows = $model->get($jalan_klas_id)) 
            echo $rows->nilai;
        else 
            echo 0;
    }
    ...
    function get_lokasi_pasang_val()
    {
        ...
        $model         = $this->load->model('rek_lokasi_pasang_model');
    ...
    function get_sudut_pandang_val()
    {
        ...
        $model         = $this->load->model('rek_sudut_pandang_model');
