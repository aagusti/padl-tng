...
function get_kelurahan(kec_id) {
	$.ajax({
		url: "<?php echo active_module_url()?>daftar/get_kelurahan/"+kec_id,
		success: function (j) {
...
function get_op_pajak(usaha_id) {
	$.ajax({
		url: "<?php echo active_module_url()?>daftar/get_op_pajak/"+usaha_id,
		success: function (j) {
			var data = $.parseJSON(j);
...
$(document).ready(function() {
	oTableKD = $('#tableKD').dataTable({
		...
		"bInfo": false,
		"sDom": '<"toolbar">frtip',
		"sAjaxSource": "<? echo active_module_url('daftar/grid_kd').$dt['id'].'?iDisplayLength=99'; ?>",
	});
	...
	var reg_date_dtp = $('#reg_datexx').datepicker({
		format: 'dd-mm-yyyy'
		...
		<?php echo form_open($faction, array('id'=>'myform','class'=>'form-horizontal'));?>
			...
			<div class="row">
				<div style="width:420px" class="span6">
					<div class="control-group">
						<label class="control-label" for="formno">No./Tgl. Daftar</label>
						<div class="controls">
							<input class="input-mini" type="text" name="formno" id="formno" value="<?=$dt['formno']?>" readonly /> / 
				...
				<div class="span4">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="input-large" type="text" name="email" id="email" value="<?=$dt['email']?>" readonly />
                        </div>
                    </div>
				</div>
			</div>
			...
			<div class="tabbable">
				<ul id="myTab" class="nav nav-tabs">
                    ...
                    <li><a href="#datapendukung" data-toggle="tab"><strong>Data Pendukung</strong></a></li>
				</ul>
				<div class="tab-content">
					<div class="tab-pane fade in <?echo $dt['id'] > 0 ? '' : 'active'; ?>" id="pemilik">
						<div class="control-group">
					...
					<div class="tab-pane fade in " id="pengelola">
						<div class="control-group">
					...
					<div class="tab-pane fade in " id="perizinan">
						<div class="row">
							<div class="span12">
								<div class="row">
					...
					<div class="tab-pane fade in active" id="op">
                        <div class="control-group">
                            <label class="control-label" for="op_nm">Nama Objek Pajak</label>
                            <div class="controls">
                                <input class="input" type="text" name="op_nm" id="op_nm" value="<?=$dt['op_nm']?>"  />
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea class="input-large" name="op_alamat" id="op_alamat" rows="1" cols="50"><?=$dt['op_alamat']?></textarea>
                            </div>
                        </div>
                        <div class="control-group">
