...
// wp_login
if ( ! function_exists('cwp_login'))
{
    function cwp_login()
    {
		$CI  =& get_instance();
		$ret =  $CI->session->userdata('cwp_login');
		return  $ret;
    }
}

// wp_id
if ( ! function_exists('cwp_id'))
{
    function cwp_id()
    {
		$CI  =& get_instance();
		$ret =  $CI->session->userdata('cwp_id');
		return  $ret;
    }
}

// wp_nm
if ( ! function_exists('cwp_nm'))
{
    function cwp_nm()
    {
		$CI  =& get_instance();
		$ret =  $CI->session->userdata('cwp_nm');
		return  $ret;
    }
}
